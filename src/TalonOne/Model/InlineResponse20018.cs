...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(int totalResultSize = default(int), List<string> data = default(List<string>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
                this.Data = data;
