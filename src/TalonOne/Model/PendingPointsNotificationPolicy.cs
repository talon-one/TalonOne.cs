...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PendingPointsNotificationPolicy :  IEquatable<PendingPointsNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PendingPointsNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PendingPointsNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PendingPointsNotificationPolicy" /> class.
        /// </summary>
        ...
        public PendingPointsNotificationPolicy(string name = default(string), bool batchingEnabled = true, int batchSize = default(int))
        {
        ...
        {
            return this.Equals(input as PendingPointsNotificationPolicy);
        }

        /// <summary>
        /// Returns true if PendingPointsNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of PendingPointsNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PendingPointsNotificationPolicy input)
        {
            if (input == null)
                return false;
