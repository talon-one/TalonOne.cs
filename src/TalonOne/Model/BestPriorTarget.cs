...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BestPriorTarget :  IEquatable<BestPriorTarget>, IValidatableObject
    {
        /// <summary>
        ...
        public BestPriorTarget(TargetTypeEnum targetType = default(TargetTypeEnum), long audienceID = default(long))
        {
        ...
        {
            return this.Equals(input as BestPriorTarget);
        }

        /// <summary>
        /// Returns true if BestPriorTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of BestPriorTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BestPriorTarget input)
        {
            if (input == null)
                return false;
