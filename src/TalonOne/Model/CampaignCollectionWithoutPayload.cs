...
namespace TalonOne.Model
{
    ...
    public partial class CampaignCollectionWithoutPayload :  IEquatable<CampaignCollectionWithoutPayload>, IValidatableObject
    {
        ...
        public CampaignCollectionWithoutPayload(int id = default(int), DateTime created = default(DateTime), int accountId = default(int), DateTime modified = default(DateTime), string description = default(string), string name = default(string), int modifiedBy = default(int), int createdBy = default(int), int applicationId = default(int), int campaignId = default(int))
        {
            this.Id = id;
