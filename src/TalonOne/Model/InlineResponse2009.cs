...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(long totalResultSize = default(long), List<Ruleset> data = default(List<Ruleset>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2009 and cannot be null");
        }
