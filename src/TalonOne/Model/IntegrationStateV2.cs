...
namespace TalonOne.Model
{
    ...
    public partial class IntegrationStateV2 :  IEquatable<IntegrationStateV2>, IValidatableObject
    {
        ...
        public IntegrationStateV2(CustomerProfile customerProfile = default(CustomerProfile), Loyalty loyalty = default(Loyalty), List<Campaign> triggeredCampaigns = default(List<Campaign>), List<Effect> effects = default(List<Effect>), List<RuleFailureReason> ruleFailureReasons = default(List<RuleFailureReason>), List<Coupon> createdCoupons = default(List<Coupon>), List<Referral> createdReferrals = default(List<Referral>), List<Giveaway> awardedGiveaways = default(List<Giveaway>), InventoryReferral referral = default(InventoryReferral), List<IntegrationCoupon> coupons = default(List<IntegrationCoupon>), Event _event = default(Event), EventV3 advancedEvent = default(EventV3), CustomerSessionV2 customerSession = default(CustomerSessionV2), Return _return = default(Return), List<Return> previousReturns = default(List<Return>))
        {
            ...
            this.CreatedCoupons = createdCoupons ?? throw new ArgumentNullException("createdCoupons is a required property for IntegrationStateV2 and cannot be null");
            // to ensure "createdReferrals" is required (not null)
            this.CreatedReferrals = createdReferrals ?? throw new ArgumentNullException("createdReferrals is a required property for IntegrationStateV2 and cannot be null");
        ...
        public List<IntegrationCoupon> Coupons { get; set; }
