...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(bool hasMore = default(bool), List<IntegrationCampaign> data = default(List<IntegrationCampaign>))
        {
            this.HasMore = hasMore;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse200 and cannot be null");
        }
        ...
        public List<IntegrationCampaign> Data { get; set; }
