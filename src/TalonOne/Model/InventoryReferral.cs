...
namespace TalonOne.Model
{
    ...
    public partial class InventoryReferral :  IEquatable<InventoryReferral>, IValidatableObject
    {
        ...
        public InventoryReferral(int id = default(int), DateTime created = default(DateTime), DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), int usageLimit = default(int), int campaignId = default(int), string advocateProfileIntegrationId = default(string), string friendProfileIntegrationId = default(string), Object attributes = default(Object), int importId = default(int), string code = default(string), int usageCounter = default(int), string batchId = default(string), List<string> referredCustomers = default(List<string>))
        {
            this.Id = id;
