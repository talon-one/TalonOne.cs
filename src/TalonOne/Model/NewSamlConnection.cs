...
namespace TalonOne.Model
{
    ...
    public partial class NewSamlConnection :  IEquatable<NewSamlConnection>, IValidatableObject
    {
        ...
        public NewSamlConnection(string x509certificate = default(string), long accountId = default(long), string name = default(string), bool enabled = default(bool), string issuer = default(string), string signOnURL = default(string), string signOutURL = default(string), string metadataURL = default(string), string audienceURI = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for NewSamlConnection and cannot be null");
            this.Enabled = enabled;
            // to ensure "issuer" is required (not null)
            this.Issuer = issuer ?? throw new ArgumentNullException("issuer is a required property for NewSamlConnection and cannot be null");
            // to ensure "signOnURL" is required (not null)
            this.SignOnURL = signOnURL ?? throw new ArgumentNullException("signOnURL is a required property for NewSamlConnection and cannot be null");
