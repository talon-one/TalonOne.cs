...
namespace TalonOne.Model
{
    ...
    public partial class NewReferralsForMultipleAdvocates :  IEquatable<NewReferralsForMultipleAdvocates>, IValidatableObject
    {
        ...
        public NewReferralsForMultipleAdvocates(DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), int usageLimit = default(int), int campaignId = default(int), List<string> advocateProfileIntegrationIds = default(List<string>), Object attributes = default(Object), List<string> validCharacters = default(List<string>), string referralPattern = default(string))
        {
            ...
            if (usageLimit == null)
            {
                throw new InvalidDataException("usageLimit is a required property for NewReferralsForMultipleAdvocates and cannot be null");
            }
            else
            {
            ...
            if (campaignId == null)
            {
                throw new InvalidDataException("campaignId is a required property for NewReferralsForMultipleAdvocates and cannot be null");
            }
            else
            {
            ...
            if (advocateProfileIntegrationIds == null)
            {
                throw new InvalidDataException("advocateProfileIntegrationIds is a required property for NewReferralsForMultipleAdvocates and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="advocateProfileIntegrationIds", EmitDefaultValue=true)]
