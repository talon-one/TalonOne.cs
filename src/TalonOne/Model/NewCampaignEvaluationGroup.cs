...
namespace TalonOne.Model
{
    ...
    public partial class NewCampaignEvaluationGroup :  IEquatable<NewCampaignEvaluationGroup>, IValidatableObject
    {
        ...
        public NewCampaignEvaluationGroup(string name = default(string), int parentId = default(int), string description = default(string), EvaluationModeEnum evaluationMode = default(EvaluationModeEnum), bool locked = default(bool))
        {
