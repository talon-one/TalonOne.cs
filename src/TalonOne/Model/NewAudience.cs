...
namespace TalonOne.Model
{
    ...
    public partial class NewAudience :  IEquatable<NewAudience>, IValidatableObject
    {
        ...
        public NewAudience(string name = default(string), IntegrationEnum integration = default(IntegrationEnum), string integrationId = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NewAudience and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (integration == null)
            {
                throw new InvalidDataException("integration is a required property for NewAudience and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("integrationId is a required property for NewAudience and cannot be null");
            }
            else
            {
