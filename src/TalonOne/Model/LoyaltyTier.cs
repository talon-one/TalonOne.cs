...
namespace TalonOne.Model
{
    ...
    public partial class LoyaltyTier :  IEquatable<LoyaltyTier>, IValidatableObject
    {
        ...
        public LoyaltyTier(int id = default(int), DateTime created = default(DateTime), int programID = default(int), string name = default(string), decimal minPoints = default(decimal))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for LoyaltyTier and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for LoyaltyTier and cannot be null");
            }
            else
            {
            ...
            if (programID == null)
            {
                throw new InvalidDataException("programID is a required property for LoyaltyTier and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for LoyaltyTier and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (minPoints == null)
            {
                throw new InvalidDataException("minPoints is a required property for LoyaltyTier and cannot be null");
            }
            else
            {
