...
namespace TalonOne.Model
{
    ...
    public partial class EventV2 :  IEquatable<EventV2>, IValidatableObject
    {
        ...
        public EventV2(string profileId = default(string), string storeIntegrationId = default(string), List<long> evaluableCampaignIds = default(List<long>), string type = default(string), Object attributes = default(Object))
        {
