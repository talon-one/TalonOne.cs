...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20026 :  IEquatable<InlineResponse20026>, IValidatableObject
    {
        ...
        public InlineResponse20026(long totalResultSize = default(long), bool hasMore = default(bool), List<ApplicationCustomer> data = default(List<ApplicationCustomer>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20026 and cannot be null");
