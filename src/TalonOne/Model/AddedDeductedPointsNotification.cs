...
namespace TalonOne.Model
{
    ...
    public partial class AddedDeductedPointsNotification :  IEquatable<AddedDeductedPointsNotification>, IValidatableObject
    {
        ...
        public AddedDeductedPointsNotification(string employeeName = default(string), long loyaltyProgramID = default(long), NotificationTypeEnum notificationType = default(NotificationTypeEnum), string profileIntegrationID = default(string), string sessionIntegrationID = default(string), string subledgerID = default(string), TypeOfChangeEnum typeOfChange = default(TypeOfChangeEnum), long userID = default(long), decimal amount = default(decimal), DateTime expiryDate = default(DateTime), OperationEnum operation = default(OperationEnum), string reason = default(string), DateTime startDate = default(DateTime), Guid transactionUUID = default(Guid))
        {
