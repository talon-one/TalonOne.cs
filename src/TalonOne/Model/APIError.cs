...
namespace TalonOne.Model
{
    ...
    public partial class APIError :  IEquatable<APIError>, IValidatableObject
    {
        ...
        public APIError(string title = default(string), string details = default(string), ErrorSource source = default(ErrorSource))
        {
            ...
            this.Title = title ?? throw new ArgumentNullException("title is a required property for APIError and cannot be null");
            // to ensure "source" is required (not null)
            this.Source = source ?? throw new ArgumentNullException("source is a required property for APIError and cannot be null");
