...
namespace TalonOne.Model
{
    ...
    public partial class RemoveFromAudienceEffectProps :  IEquatable<RemoveFromAudienceEffectProps>, IValidatableObject
    {
        ...
        public RemoveFromAudienceEffectProps(int audienceId = default(int), string audienceName = default(string), string profileIntegrationId = default(string), int profileId = default(int))
        {
