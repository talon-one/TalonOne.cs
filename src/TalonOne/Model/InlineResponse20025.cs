...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(int totalResultSize = default(int), List<WebhookLogEntry> data = default(List<WebhookLogEntry>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20025 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20025 and cannot be null");
            }
            else
            {
                this.Data = data;
