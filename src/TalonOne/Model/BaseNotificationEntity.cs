...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseNotificationEntity :  IEquatable<BaseNotificationEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseNotificationEntity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BaseNotificationEntity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseNotificationEntity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BaseNotificationEntity);
        }

        /// <summary>
        /// Returns true if BaseNotificationEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseNotificationEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseNotificationEntity input)
        {
            if (input == null)
                return false;
