...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(bool hasMore = default(bool), List<CardLedgerTransactionLogEntryIntegrationAPI> data = default(List<CardLedgerTransactionLogEntryIntegrationAPI>))
        {
            this.HasMore = hasMore;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2003 and cannot be null");
        }
