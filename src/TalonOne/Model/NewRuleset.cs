...
namespace TalonOne.Model
{
    ...
    public partial class NewRuleset :  IEquatable<NewRuleset>, IValidatableObject
    {
        ...
        public NewRuleset(List<Rule> rules = default(List<Rule>), List<Rule> strikethroughRules = default(List<Rule>), List<Binding> bindings = default(List<Binding>), string rbVersion = default(string), bool activate = default(bool))
        {
        ...
        [DataMember(Name="strikethroughRules", EmitDefaultValue=false)]
        public List<Rule> StrikethroughRules { get; set; }
        ...
        public bool Equals(NewRuleset input)
        {
            ...
            return 
                ...
                (
                    this.StrikethroughRules == input.StrikethroughRules ||
                    this.StrikethroughRules != null &&
                    input.StrikethroughRules != null &&
                    this.StrikethroughRules.SequenceEqual(input.StrikethroughRules)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StrikethroughRules != null)
                    hashCode = hashCode * 59 + this.StrikethroughRules.GetHashCode();
