...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ManagementKey :  IEquatable<ManagementKey>, IValidatableObject
    {
        /// <summary>
        ...
        public ManagementKey(string name = default(string), DateTime expiryDate = default(DateTime), List<Endpoint> endpoints = default(List<Endpoint>), List<long> allowedApplicationIds = default(List<long>), long id = default(long), long createdBy = default(long), long accountID = default(long), DateTime created = default(DateTime), bool disabled = default(bool))
        {
            ...
            this.Endpoints = endpoints ?? throw new ArgumentNullException("endpoints is a required property for ManagementKey and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as ManagementKey);
        }

        /// <summary>
        /// Returns true if ManagementKey instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagementKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagementKey input)
        {
            if (input == null)
                return false;
