...
namespace TalonOne.Model
{
    ...
    public partial class WillAwardGiveawayEffectProps :  IEquatable<WillAwardGiveawayEffectProps>, IValidatableObject
    {
        ...
        public WillAwardGiveawayEffectProps(int poolId = default(int), string poolName = default(string), string recipientIntegrationId = default(string))
        {
            ...
            if (poolId == null)
            {
                throw new InvalidDataException("poolId is a required property for WillAwardGiveawayEffectProps and cannot be null");
            }
            else
            {
                this.PoolId = poolId;
            ...
            if (poolName == null)
            {
                throw new InvalidDataException("poolName is a required property for WillAwardGiveawayEffectProps and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("recipientIntegrationId is a required property for WillAwardGiveawayEffectProps and cannot be null");
            }
            else
            {
