...
namespace TalonOne.Model
{
    ...
    public partial class AudienceCustomer :  IEquatable<AudienceCustomer>, IValidatableObject
    {
        ...
        public AudienceCustomer(long id = default(long), DateTime created = default(DateTime), string integrationId = default(string), Object attributes = default(Object), long accountId = default(long), long closedSessions = default(long), decimal totalSales = default(decimal), List<LoyaltyMembership> loyaltyMemberships = default(List<LoyaltyMembership>), List<AudienceMembership> audienceMemberships = default(List<AudienceMembership>), DateTime lastActivity = default(DateTime), bool sandbox = default(bool), List<long> connectedApplicationsIds = default(List<long>), List<long> connectedAudiences = default(List<long>))
        {
            this.Id = id;
        ...
        public List<long> ConnectedApplicationsIds { get; set; }
        ...
        public List<long> ConnectedAudiences { get; set; }
