...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(long totalResultSize = default(long), List<AchievementStatusEntry> data = default(List<AchievementStatusEntry>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2001 and cannot be null");
        }
        ...
        public List<AchievementStatusEntry> Data { get; set; }
