...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>, IValidatableObject
    {
        ...
        public InlineResponse20019(bool hasMore = default(bool), int totalResultSize = default(int), List<ApplicationReferee> data = default(List<ApplicationReferee>))
        {
            // to ensure "hasMore" is required (not null)
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for InlineResponse20019 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20019 and cannot be null");
            }
            else
            {
