...
namespace TalonOne.Model
{
    ...
    public partial class NewCouponsForMultipleRecipients :  IEquatable<NewCouponsForMultipleRecipients>, IValidatableObject
    {
        ...
        public NewCouponsForMultipleRecipients(int usageLimit = default(int), decimal discountLimit = default(decimal), DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), Object attributes = default(Object), List<string> recipientsIntegrationIds = default(List<string>), List<string> validCharacters = default(List<string>), string couponPattern = default(string))
        {
            ...
            if (usageLimit == null)
            {
                throw new InvalidDataException("usageLimit is a required property for NewCouponsForMultipleRecipients and cannot be null");
            }
            else
            {
            ...
            if (recipientsIntegrationIds == null)
            {
                throw new InvalidDataException("recipientsIntegrationIds is a required property for NewCouponsForMultipleRecipients and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="recipientsIntegrationIds", EmitDefaultValue=true)]
