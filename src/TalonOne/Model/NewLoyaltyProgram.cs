...
namespace TalonOne.Model
{
    ...
    public partial class NewLoyaltyProgram :  IEquatable<NewLoyaltyProgram>, IValidatableObject
    {
        ...
        public NewLoyaltyProgram(string name = default(string), string title = default(string), string description = default(string), List<int?> subscribedApplications = default(List<int?>), string defaultValidity = default(string), bool? allowSubledger = default(bool?))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewLoyaltyProgram and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("defaultValidity is a required property for NewLoyaltyProgram and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("allowSubledger is a required property for NewLoyaltyProgram and cannot be null");
            }
            else
            {
