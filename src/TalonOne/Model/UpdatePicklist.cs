...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePicklist :  IEquatable<UpdatePicklist>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdatePicklist(TypeEnum type = default(TypeEnum), List<string> values = default(List<string>))
        {
            this.Type = type;
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for UpdatePicklist and cannot be null");
        }
        ...
        {
            return this.Equals(input as UpdatePicklist);
        }

        /// <summary>
        /// Returns true if UpdatePicklist instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePicklist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePicklist input)
        {
            if (input == null)
                return false;
