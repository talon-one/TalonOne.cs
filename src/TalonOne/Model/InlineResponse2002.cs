...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(long totalResultSize = default(long), List<AchievementStatusEntry> data = default(List<AchievementStatusEntry>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2002 and cannot be null");
        }
