...
namespace TalonOne.Model
{
    ...
    public partial class RejectCouponEffectProps :  IEquatable<RejectCouponEffectProps>, IValidatableObject
    {
        ...
        public RejectCouponEffectProps(string value = default(string), string rejectionReason = default(string), long conditionIndex = default(long), long effectIndex = default(long), string details = default(string), string campaignExclusionReason = default(string))
        {
