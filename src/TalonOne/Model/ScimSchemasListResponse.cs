...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScimSchemasListResponse :  IEquatable<ScimSchemasListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScimSchemasListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScimSchemasListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScimSchemasListResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ScimSchemasListResponse);
        }

        /// <summary>
        /// Returns true if ScimSchemasListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimSchemasListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimSchemasListResponse input)
        {
            if (input == null)
                return false;
