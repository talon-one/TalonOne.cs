...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleV2Base :  IEquatable<RoleV2Base>, IValidatableObject
    {
        /// <summary>
        ...
        public RoleV2Base(string name = default(string), string description = default(string), bool isAdmin = default(bool), RoleV2Permissions permissions = default(RoleV2Permissions), List<int> members = default(List<int>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as RoleV2Base);
        }

        /// <summary>
        /// Returns true if RoleV2Base instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleV2Base to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleV2Base input)
        {
            if (input == null)
                return false;
