...
namespace TalonOne.Model
{
    ...
    public partial class CampaignCollectionEditedNotification :  IEquatable<CampaignCollectionEditedNotification>, IValidatableObject
    {
        ...
        public CampaignCollectionEditedNotification(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<CampaignCollectionEditedNotificationItem> data = default(List<CampaignCollectionEditedNotificationItem>))
        {
