...
namespace TalonOne.Model
{
    ...
    public partial class Change :  IEquatable<Change>, IValidatableObject
    {
        ...
        public Change(int? id = default(int?), DateTime? created = default(DateTime?), int? userId = default(int?), string entity = default(string), Object old = default(Object), Object _new = default(Object))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Change and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for Change and cannot be null");
            }
            else
            {
            ...
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for Change and cannot be null");
            }
            else
            {
                this.UserId = userId;
            ...
            if (entity == null)
            {
                throw new InvalidDataException("entity is a required property for Change and cannot be null");
            }
            else
            {
                this.Entity = entity;
