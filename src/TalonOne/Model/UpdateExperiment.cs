...
namespace TalonOne.Model
{
    ...
    public partial class UpdateExperiment :  IEquatable<UpdateExperiment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateExperiment);
        }

        /// <summary>
        /// Returns true if UpdateExperiment instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExperiment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExperiment input)
        {
            if (input == null)
                return false;
