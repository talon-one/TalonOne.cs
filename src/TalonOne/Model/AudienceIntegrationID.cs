...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AudienceIntegrationID :  IEquatable<AudienceIntegrationID>, IValidatableObject
    {
        /// <summary>
        ...
        public AudienceIntegrationID(string integrationId = default(string))
        {
        ...
        {
            return this.Equals(input as AudienceIntegrationID);
        }

        /// <summary>
        /// Returns true if AudienceIntegrationID instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceIntegrationID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceIntegrationID input)
        {
            if (input == null)
                return false;
