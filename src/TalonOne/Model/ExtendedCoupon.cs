...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtendedCoupon :  IEquatable<ExtendedCoupon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedCoupon" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExtendedCoupon() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedCoupon" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExtendedCoupon);
        }

        /// <summary>
        /// Returns true if ExtendedCoupon instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtendedCoupon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtendedCoupon input)
        {
            if (input == null)
                return false;
