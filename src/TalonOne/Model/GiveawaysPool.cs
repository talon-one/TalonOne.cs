...
namespace TalonOne.Model
{
    ...
    public partial class GiveawaysPool :  IEquatable<GiveawaysPool>, IValidatableObject
    {
        ...
        public GiveawaysPool(int id = default(int), DateTime created = default(DateTime), int accountId = default(int), string name = default(string), string description = default(string), List<int> subscribedApplicationsIds = default(List<int>), DateTime modified = default(DateTime), int createdBy = default(int), int modifiedBy = default(int))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GiveawaysPool and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for GiveawaysPool and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for GiveawaysPool and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GiveawaysPool and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (createdBy == null)
            {
                throw new InvalidDataException("createdBy is a required property for GiveawaysPool and cannot be null");
            }
            else
            {
