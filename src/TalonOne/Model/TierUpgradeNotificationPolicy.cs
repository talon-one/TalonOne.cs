...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TierUpgradeNotificationPolicy :  IEquatable<TierUpgradeNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TierUpgradeNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TierUpgradeNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TierUpgradeNotificationPolicy" /> class.
        /// </summary>
        ...
        public TierUpgradeNotificationPolicy(string name = default(string), bool batchingEnabled = true, int batchSize = default(int))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TierUpgradeNotificationPolicy and cannot be null");
        ...
        {
            return this.Equals(input as TierUpgradeNotificationPolicy);
        }

        /// <summary>
        /// Returns true if TierUpgradeNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of TierUpgradeNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TierUpgradeNotificationPolicy input)
        {
            if (input == null)
                return false;
