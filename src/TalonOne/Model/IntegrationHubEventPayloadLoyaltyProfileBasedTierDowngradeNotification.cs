...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification :  IEquatable<IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification>, IValidatableObject
    {
        /// <summary>
        ...
        protected IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification" /> class.
        /// </summary>
        ...
        public IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification(string profileIntegrationID = default(string), long loyaltyProgramID = default(long), string subledgerID = default(string), string sourceOfEvent = default(string), string currentTier = default(string), float currentPoints = default(float), string oldTier = default(string), DateTime tierExpirationDate = default(DateTime), DateTime timestampOfTierChange = default(DateTime), DateTime publishedAt = default(DateTime))
        {
            ...
            this.SourceOfEvent = sourceOfEvent ?? throw new ArgumentNullException("sourceOfEvent is a required property for IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification and cannot be null");
        ...
        {
            return this.Equals(input as IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification);
        }

        /// <summary>
        /// Returns true if IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification input)
        {
            if (input == null)
                return false;
