...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogRule :  IEquatable<CatalogRule>, IValidatableObject
    {
        /// <summary>
        ...
        public CatalogRule(string title = default(string), List<Binding> bindings = default(List<Binding>), List<Object> condition = default(List<Object>), List<Object> effects = default(List<Object>))
        {
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for CatalogRule and cannot be null");
            // to ensure "condition" is required (not null)
            this.Condition = condition ?? throw new ArgumentNullException("condition is a required property for CatalogRule and cannot be null");
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for CatalogRule and cannot be null");
        ...
        {
            return this.Equals(input as CatalogRule);
        }

        /// <summary>
        /// Returns true if CatalogRule instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogRule input)
        {
            if (input == null)
                return false;
