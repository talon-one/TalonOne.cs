...
namespace TalonOne.Model
{
    ...
    public partial class UpdateCustomEffect :  IEquatable<UpdateCustomEffect>, IValidatableObject
    {
        ...
        public UpdateCustomEffect(string name = default(string), string title = default(string), string payload = default(string), string description = default(string), bool enabled = default(bool), List<int> subscribedApplicationsIds = default(List<int>), List<TemplateArgDef> _params = default(List<TemplateArgDef>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UpdateCustomEffect and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for UpdateCustomEffect and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (payload == null)
            {
                throw new InvalidDataException("payload is a required property for UpdateCustomEffect and cannot be null");
            }
            else
            {
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for UpdateCustomEffect and cannot be null");
            }
            else
            {
