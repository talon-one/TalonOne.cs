...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(int totalResultSize = default(int), List<Ruleset> data = default(List<Ruleset>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse2004 and cannot be null");
            }
            else
            {
