...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchievementBaseV2 :  IEquatable<AchievementBaseV2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AchievementBaseV2" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AchievementBaseV2 {\n");
        ...
        {
            return this.Equals(input as AchievementBaseV2);
        }

        /// <summary>
        /// Returns true if AchievementBaseV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AchievementBaseV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchievementBaseV2 input)
        {
            if (input == null)
                return false;
