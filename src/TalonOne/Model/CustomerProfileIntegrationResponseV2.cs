...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomerProfileIntegrationResponseV2 :  IEquatable<CustomerProfileIntegrationResponseV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerProfileIntegrationResponseV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomerProfileIntegrationResponseV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerProfileIntegrationResponseV2" /> class.
        /// </summary>
        ...
        public CustomerProfileIntegrationResponseV2(CustomerProfile customerProfile = default(CustomerProfile), Event _event = default(Event), Loyalty loyalty = default(Loyalty), List<Campaign> triggeredCampaigns = default(List<Campaign>), List<RuleFailureReason> ruleFailureReasons = default(List<RuleFailureReason>), List<Giveaway> awardedGiveaways = default(List<Giveaway>), List<Effect> effects = default(List<Effect>), List<Coupon> createdCoupons = default(List<Coupon>), List<Referral> createdReferrals = default(List<Referral>))
        {
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for CustomerProfileIntegrationResponseV2 and cannot be null");
            // to ensure "createdCoupons" is required (not null)
            this.CreatedCoupons = createdCoupons ?? throw new ArgumentNullException("createdCoupons is a required property for CustomerProfileIntegrationResponseV2 and cannot be null");
            // to ensure "createdReferrals" is required (not null)
            this.CreatedReferrals = createdReferrals ?? throw new ArgumentNullException("createdReferrals is a required property for CustomerProfileIntegrationResponseV2 and cannot be null");
        ...
        {
            return this.Equals(input as CustomerProfileIntegrationResponseV2);
        }

        /// <summary>
        /// Returns true if CustomerProfileIntegrationResponseV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerProfileIntegrationResponseV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerProfileIntegrationResponseV2 input)
        {
            if (input == null)
                return false;
