...
namespace TalonOne.Model
{
    ...
    public partial class Event :  IEquatable<Event>, IValidatableObject
    {
        ...
        public Event(long id = default(long), DateTime created = default(DateTime), long applicationId = default(long), string profileId = default(string), string storeIntegrationId = default(string), string type = default(string), Object attributes = default(Object), string sessionId = default(string), List<Object> effects = default(List<Object>), List<LedgerEntry> ledgerEntries = default(List<LedgerEntry>), Meta meta = default(Meta))
        {
            this.Id = id;
