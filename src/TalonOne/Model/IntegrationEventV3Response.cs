...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationEventV3Response :  IEquatable<IntegrationEventV3Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationEventV3Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IntegrationEventV3Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationEventV3Response" /> class.
        /// </summary>
        ...
        /// <param name="advancedEvent">advancedEvent.</param>
        public IntegrationEventV3Response(CustomerProfile customerProfile = default(CustomerProfile), Loyalty loyalty = default(Loyalty), List<Campaign> triggeredCampaigns = default(List<Campaign>), List<Effect> effects = default(List<Effect>), List<RuleFailureReason> ruleFailureReasons = default(List<RuleFailureReason>), List<Coupon> createdCoupons = default(List<Coupon>), List<Referral> createdReferrals = default(List<Referral>), List<Giveaway> awardedGiveaways = default(List<Giveaway>), EventV3 advancedEvent = default(EventV3))
        {
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for IntegrationEventV3Response and cannot be null");
            // to ensure "createdCoupons" is required (not null)
            this.CreatedCoupons = createdCoupons ?? throw new ArgumentNullException("createdCoupons is a required property for IntegrationEventV3Response and cannot be null");
            // to ensure "createdReferrals" is required (not null)
            this.CreatedReferrals = createdReferrals ?? throw new ArgumentNullException("createdReferrals is a required property for IntegrationEventV3Response and cannot be null");
        ...
        /// <summary>
        /// Gets or Sets AdvancedEvent
        /// </summary>
        [DataMember(Name="advancedEvent", EmitDefaultValue=false)]
        public EventV3 AdvancedEvent { get; set; }
        ...
        {
            return this.Equals(input as IntegrationEventV3Response);
        }

        /// <summary>
        /// Returns true if IntegrationEventV3Response instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationEventV3Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationEventV3Response input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AdvancedEvent == input.AdvancedEvent ||
                    (this.AdvancedEvent != null &&
                    this.AdvancedEvent.Equals(input.AdvancedEvent))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AdvancedEvent != null)
                    hashCode = hashCode * 59 + this.AdvancedEvent.GetHashCode();
                return hashCode;
            }
        }
