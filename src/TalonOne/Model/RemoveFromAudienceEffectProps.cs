...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveFromAudienceEffectProps :  IEquatable<RemoveFromAudienceEffectProps>, IValidatableObject
    {
        /// <summary>
        ...
        public RemoveFromAudienceEffectProps(long audienceId = default(long), string audienceName = default(string), string profileIntegrationId = default(string), long profileId = default(long))
        {
        ...
        {
            return this.Equals(input as RemoveFromAudienceEffectProps);
        }

        /// <summary>
        /// Returns true if RemoveFromAudienceEffectProps instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveFromAudienceEffectProps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveFromAudienceEffectProps input)
        {
            if (input == null)
                return false;
