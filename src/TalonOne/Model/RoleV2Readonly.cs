...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleV2Readonly :  IEquatable<RoleV2Readonly>, IValidatableObject
    {
        /// <summary>
        ...
        public RoleV2Readonly(bool isReadonly = false)
        {
        ...
        {
            return this.Equals(input as RoleV2Readonly);
        }

        /// <summary>
        /// Returns true if RoleV2Readonly instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleV2Readonly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleV2Readonly input)
        {
            if (input == null)
                return false;
