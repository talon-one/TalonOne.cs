...
namespace TalonOne.Model
{
    ...
    public partial class NewLoyaltyProgram :  IEquatable<NewLoyaltyProgram>, IValidatableObject
    {
        ...
        public NewLoyaltyProgram(string title = default(string), string description = default(string), List<int> subscribedApplications = default(List<int>), string defaultValidity = default(string), string defaultPending = default(string), bool allowSubledger = default(bool), string timezone = default(string), string name = default(string), List<NewLoyaltyTier> tiers = default(List<NewLoyaltyTier>))
        {
