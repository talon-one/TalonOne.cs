...
namespace TalonOne.Model
{
    ...
    public partial class CampaignDeletedNotification :  IEquatable<CampaignDeletedNotification>, IValidatableObject
    {
        ...
        public CampaignDeletedNotification(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<CampaignDeletedNotificationItem> data = default(List<CampaignDeletedNotificationItem>))
        {
