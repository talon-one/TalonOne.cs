...
namespace TalonOne.Model
{
    ...
    public partial class NewCampaignEvaluationGroup :  IEquatable<NewCampaignEvaluationGroup>, IValidatableObject
    {
        ...
        public NewCampaignEvaluationGroup(string name = default(string), long parentId = default(long), string description = default(string), EvaluationModeEnum evaluationMode = default(EvaluationModeEnum), EvaluationScopeEnum evaluationScope = default(EvaluationScopeEnum), bool locked = default(bool))
        {
