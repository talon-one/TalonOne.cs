...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpiringCouponsNotificationPolicy :  IEquatable<ExpiringCouponsNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpiringCouponsNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpiringCouponsNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpiringCouponsNotificationPolicy" /> class.
        /// </summary>
        ...
        public ExpiringCouponsNotificationPolicy(string name = default(string), List<ExpiringCouponsNotificationTrigger> triggers = default(List<ExpiringCouponsNotificationTrigger>), bool batchingEnabled = true, int batchSize = default(int))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ExpiringCouponsNotificationPolicy and cannot be null");
            // to ensure "triggers" is required (not null)
            this.Triggers = triggers ?? throw new ArgumentNullException("triggers is a required property for ExpiringCouponsNotificationPolicy and cannot be null");
        ...
        {
            return this.Equals(input as ExpiringCouponsNotificationPolicy);
        }

        /// <summary>
        /// Returns true if ExpiringCouponsNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpiringCouponsNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpiringCouponsNotificationPolicy input)
        {
            if (input == null)
                return false;
