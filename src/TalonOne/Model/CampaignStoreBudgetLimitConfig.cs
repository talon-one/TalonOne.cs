...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignStoreBudgetLimitConfig :  IEquatable<CampaignStoreBudgetLimitConfig>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStoreBudgetLimitConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignStoreBudgetLimitConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStoreBudgetLimitConfig" /> class.
        /// </summary>
        ...
        /// <param name="imported">Indicates whether this limit configuration is managed via a CSV file. (required).</param>
        public CampaignStoreBudgetLimitConfig(string action = default(string), decimal limit = default(decimal), PeriodEnum? period = default(PeriodEnum?), List<EntitiesEnum> entities = default(List<EntitiesEnum>), bool imported = default(bool))
        {
            // to ensure "action" is required (not null)
            this.Action = action ?? throw new ArgumentNullException("action is a required property for CampaignStoreBudgetLimitConfig and cannot be null");
            this.Limit = limit;
            // to ensure "entities" is required (not null)
            this.Entities = entities ?? throw new ArgumentNullException("entities is a required property for CampaignStoreBudgetLimitConfig and cannot be null");
        ...
        /// </summary>
        /// <value>Indicates whether this limit configuration is managed via a CSV file.</value>
        ...
        {
            return this.Equals(input as CampaignStoreBudgetLimitConfig);
        }

        /// <summary>
        /// Returns true if CampaignStoreBudgetLimitConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignStoreBudgetLimitConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignStoreBudgetLimitConfig input)
        {
            if (input == null)
                return false;
