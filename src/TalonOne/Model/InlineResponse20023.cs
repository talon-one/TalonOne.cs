...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20023 :  IEquatable<InlineResponse20023>, IValidatableObject
    {
        ...
        protected InlineResponse20023() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20023" /> class.
        /// </summary>
        /// <param name="totalResultSize">totalResultSize (required).</param>
        /// <param name="data">data (required).</param>
        public InlineResponse20023(int totalResultSize = default(int), List<WebhookActivationLogEntry> data = default(List<WebhookActivationLogEntry>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20023 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20023 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public List<WebhookActivationLogEntry> Data { get; set; }
