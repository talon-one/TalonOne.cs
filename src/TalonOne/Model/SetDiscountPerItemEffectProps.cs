...
namespace TalonOne.Model
{
    ...
    public partial class SetDiscountPerItemEffectProps :  IEquatable<SetDiscountPerItemEffectProps>, IValidatableObject
    {
        ...
        public SetDiscountPerItemEffectProps(string name = default(string), decimal value = default(decimal), decimal position = default(decimal), decimal subPosition = default(decimal))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SetDiscountPerItemEffectProps and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for SetDiscountPerItemEffectProps and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (position == null)
            {
                throw new InvalidDataException("position is a required property for SetDiscountPerItemEffectProps and cannot be null");
            }
            else
            {
