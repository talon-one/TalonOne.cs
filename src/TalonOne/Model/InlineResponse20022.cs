...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>, IValidatableObject
    {
        ...
        public InlineResponse20022(bool hasMore = default(bool), long totalResultSize = default(long), List<CollectionWithoutPayload> data = default(List<CollectionWithoutPayload>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20022 and cannot be null");
