...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignNotificationPolicy :  IEquatable<CampaignNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignNotificationPolicy" /> class.
        /// </summary>
        ...
        /// <param name="batchSize">The required size of each batch of data. This value applies only when &#x60;batchingEnabled&#x60; is &#x60;true&#x60;. (default to 5).</param>
        public CampaignNotificationPolicy(string name = default(string), bool batchingEnabled = true, long batchSize = 5)
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CampaignNotificationPolicy and cannot be null");
        ...
        {
            return this.Equals(input as CampaignNotificationPolicy);
        }

        /// <summary>
        /// Returns true if CampaignNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignNotificationPolicy input)
        {
            if (input == null)
                return false;
