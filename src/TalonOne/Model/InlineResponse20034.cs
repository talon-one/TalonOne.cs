...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(int totalResultSize = default(int), List<WebhookWithOutgoingIntegrationDetails> data = default(List<WebhookWithOutgoingIntegrationDetails>))
        {
