...
namespace TalonOne.Model
{
    ...
    public partial class CampaignNotificationGeneric :  IEquatable<CampaignNotificationGeneric>, IValidatableObject
    {
        ...
        public CampaignNotificationGeneric(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<Object> data = default(List<Object>))
        {
