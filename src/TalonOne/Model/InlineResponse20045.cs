...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20045 :  IEquatable<InlineResponse20045>, IValidatableObject
    {
        ...
        public InlineResponse20045(long totalResultSize = default(long), List<Export> data = default(List<Export>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20045 and cannot be null");
        }
