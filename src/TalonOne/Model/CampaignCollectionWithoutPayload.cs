...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignCollectionWithoutPayload :  IEquatable<CampaignCollectionWithoutPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCollectionWithoutPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignCollectionWithoutPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCollectionWithoutPayload" /> class.
        /// </summary>
        ...
        public CampaignCollectionWithoutPayload(long id = default(long), DateTime created = default(DateTime), long accountId = default(long), DateTime modified = default(DateTime), string description = default(string), string name = default(string), long modifiedBy = default(long), long createdBy = default(long), long applicationId = default(long), long campaignId = default(long))
        {
            this.Id = id;
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CampaignCollectionWithoutPayload and cannot be null");
        ...
        {
            return this.Equals(input as CampaignCollectionWithoutPayload);
        }

        /// <summary>
        /// Returns true if CampaignCollectionWithoutPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignCollectionWithoutPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignCollectionWithoutPayload input)
        {
            if (input == null)
                return false;
