...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAchievement :  IEquatable<CreateAchievement>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAchievement(string name = default(string), string title = default(string), string description = default(string), decimal target = default(decimal), string period = default(string), TimePoint periodEndOverride = default(TimePoint))
        {
            ...
            this.Title = title ?? throw new ArgumentNullException("title is a required property for CreateAchievement and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateAchievement and cannot be null");
            this.Target = target;
            // to ensure "period" is required (not null)
            this.Period = period ?? throw new ArgumentNullException("period is a required property for CreateAchievement and cannot be null");
        ...
        {
            return this.Equals(input as CreateAchievement);
        }

        /// <summary>
        /// Returns true if CreateAchievement instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAchievement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAchievement input)
        {
            if (input == null)
                return false;
