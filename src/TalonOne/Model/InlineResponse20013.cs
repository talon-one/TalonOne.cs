...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(long totalResultSize = default(long), List<CampaignGroup> data = default(List<CampaignGroup>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20013 and cannot be null");
        }
        ...
        public List<CampaignGroup> Data { get; set; }
