...
namespace TalonOne.Model
{
    ...
    public partial class SetDiscountPerAdditionalCostEffectProps :  IEquatable<SetDiscountPerAdditionalCostEffectProps>, IValidatableObject
    {
        ...
        public SetDiscountPerAdditionalCostEffectProps(string name = default(string), int additionalCostId = default(int), string additionalCost = default(string), decimal value = default(decimal))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SetDiscountPerAdditionalCostEffectProps and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            // to ensure "additionalCostId" is required (not null)
            if (additionalCostId == null)
            {
                throw new InvalidDataException("additionalCostId is a required property for SetDiscountPerAdditionalCostEffectProps and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("additionalCost is a required property for SetDiscountPerAdditionalCostEffectProps and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for SetDiscountPerAdditionalCostEffectProps and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        [DataMember(Name="additionalCostId", EmitDefaultValue=true)]
        ...
        [DataMember(Name="additionalCost", EmitDefaultValue=true)]
