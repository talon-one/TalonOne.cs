...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(long totalResultSize = default(long), List<Ruleset> data = default(List<Ruleset>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20010 and cannot be null");
        }
        ...
        public List<Ruleset> Data { get; set; }
