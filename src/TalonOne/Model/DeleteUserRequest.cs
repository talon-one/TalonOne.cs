...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteUserRequest :  IEquatable<DeleteUserRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteUserRequest(string email = default(string))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for DeleteUserRequest and cannot be null");
        }
        ...
        /// <summary>
        /// Returns true if DeleteUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteUserRequest to be compared</param>
        /// <returns>Boolean</returns>
