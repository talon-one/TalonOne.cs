...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScimBaseUser :  IEquatable<ScimBaseUser>, IValidatableObject
    {
        /// <summary>
        ...
        public ScimBaseUser(bool active = default(bool), string displayName = default(string), string userName = default(string), ScimBaseUserName name = default(ScimBaseUserName))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as ScimBaseUser);
        }

        /// <summary>
        /// Returns true if ScimBaseUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimBaseUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimBaseUser input)
        {
            if (input == null)
                return false;
