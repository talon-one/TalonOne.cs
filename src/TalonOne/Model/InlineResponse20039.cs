...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20039 :  IEquatable<InlineResponse20039>, IValidatableObject
    {
        ...
        public InlineResponse20039(long totalResultSize = default(long), List<WebhookWithOutgoingIntegrationDetails> data = default(List<WebhookWithOutgoingIntegrationDetails>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20039 and cannot be null");
        }
