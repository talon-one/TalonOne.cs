...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewNotificationTest :  IEquatable<NewNotificationTest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>API method for this notification.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewNotificationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewNotificationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewNotificationTest" /> class.
        /// </summary>
        ...
        /// <param name="verb">API method for this notification. (required).</param>
        /// <param name="url">API URL for the given notification. (required).</param>
        /// <param name="payload">API payload of this notification. (required).</param>
        public NewNotificationTest(TypeEnum type = default(TypeEnum), Dictionary<string, string> queryParams = default(Dictionary<string, string>), Dictionary<string, string> headers = default(Dictionary<string, string>), VerbEnum verb = default(VerbEnum), string url = default(string), string payload = default(string))
        {
            this.Type = type;
            this.Verb = verb;
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for NewNotificationTest and cannot be null");
            // to ensure "payload" is required (not null)
            this.Payload = payload ?? throw new ArgumentNullException("payload is a required property for NewNotificationTest and cannot be null");
        ...
        /// </summary>
        /// <value>API URL for the given notification.</value>
        ...
        /// </summary>
        /// <value>API payload of this notification.</value>
        ...
        {
            return this.Equals(input as NewNotificationTest);
        }

        /// <summary>
        /// Returns true if NewNotificationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewNotificationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewNotificationTest input)
        {
            if (input == null)
                return false;
