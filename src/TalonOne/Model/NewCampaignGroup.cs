...
namespace TalonOne.Model
{
    ...
    public partial class NewCampaignGroup :  IEquatable<NewCampaignGroup>, IValidatableObject
    {
        ...
        public NewCampaignGroup(string name = default(string), string description = default(string), List<long> subscribedApplicationsIds = default(List<long>), List<long> campaignIds = default(List<long>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for NewCampaignGroup and cannot be null");
