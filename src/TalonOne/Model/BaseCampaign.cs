...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseCampaign :  IEquatable<BaseCampaign>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCampaign" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BaseCampaign() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCampaign" /> class.
        /// </summary>
        ...
        /// <param name="activeRulesetId">[ID of Ruleset](https://docs.talon.one/management-api#tag/Campaigns/operation/getRulesets) this campaign applies on customer session evaluation. .</param>
        ...
        public BaseCampaign(string name = default(string), string description = default(string), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), Object attributes = default(Object), StateEnum state = StateEnum.Enabled, long activeRulesetId = default(long), List<string> tags = default(List<string>), bool reevaluateOnReturn = default(bool), List<FeaturesEnum> features = default(List<FeaturesEnum>), CodeGeneratorSettings couponSettings = default(CodeGeneratorSettings), CodeGeneratorSettings referralSettings = default(CodeGeneratorSettings), List<LimitConfig> limits = default(List<LimitConfig>), List<long> campaignGroups = default(List<long>), TypeEnum? type = TypeEnum.Advanced, List<long> linkedStoreIds = default(List<long>), Object couponAttributes = default(Object))
        {
            ...
            this.Tags = tags ?? throw new ArgumentNullException("tags is a required property for BaseCampaign and cannot be null");
            // to ensure "features" is required (not null)
            this.Features = features ?? throw new ArgumentNullException("features is a required property for BaseCampaign and cannot be null");
            // to ensure "limits" is required (not null)
            this.Limits = limits ?? throw new ArgumentNullException("limits is a required property for BaseCampaign and cannot be null");
        ...
        {
            return this.Equals(input as BaseCampaign);
        }

        /// <summary>
        /// Returns true if BaseCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCampaign input)
        {
            if (input == null)
                return false;
