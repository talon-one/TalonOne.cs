...
namespace TalonOne.Model
{
    ...
    public partial class RuleFailureReason :  IEquatable<RuleFailureReason>, IValidatableObject
    {
        ...
        public RuleFailureReason(int campaignID = default(int), string campaignName = default(string), int rulesetID = default(int), int couponID = default(int), string couponValue = default(string), int referralID = default(int), string referralValue = default(string), int ruleIndex = default(int), string ruleName = default(string), int conditionIndex = default(int), int effectIndex = default(int), string details = default(string))
        {
            ...
            if (campaignID == null)
            {
                throw new InvalidDataException("campaignID is a required property for RuleFailureReason and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignName is a required property for RuleFailureReason and cannot be null");
            }
            else
            {
            ...
            if (rulesetID == null)
            {
                throw new InvalidDataException("rulesetID is a required property for RuleFailureReason and cannot be null");
            }
            else
            {
            ...
            if (ruleIndex == null)
            {
                throw new InvalidDataException("ruleIndex is a required property for RuleFailureReason and cannot be null");
            }
            else
            {
            ...
            if (ruleName == null)
            {
                throw new InvalidDataException("ruleName is a required property for RuleFailureReason and cannot be null");
            }
            else
            {
