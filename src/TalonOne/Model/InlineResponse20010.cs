...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(int totalResultSize = default(int), List<CampaignAnalytics> data = default(List<CampaignAnalytics>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Data = data;
