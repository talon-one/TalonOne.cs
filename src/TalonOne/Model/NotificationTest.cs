...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationTest :  IEquatable<NotificationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotificationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationTest" /> class.
        /// </summary>
        ...
        public NotificationTest(string httpResponse = default(string), int httpStatus = default(int))
        {
            // to ensure "httpResponse" is required (not null)
            this.HttpResponse = httpResponse ?? throw new ArgumentNullException("httpResponse is a required property for NotificationTest and cannot be null");
        ...
        {
            return this.Equals(input as NotificationTest);
        }

        /// <summary>
        /// Returns true if NotificationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationTest input)
        {
            if (input == null)
                return false;
