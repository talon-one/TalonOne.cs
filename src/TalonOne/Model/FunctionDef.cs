...
namespace TalonOne.Model
{
    ...
    public partial class FunctionDef :  IEquatable<FunctionDef>, IValidatableObject
    {
        ...
        public FunctionDef(string name = default(string), string type = default(string), string description = default(string), string help = default(string), List<FuncArgDef> args = default(List<FuncArgDef>))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionDef and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for FunctionDef and cannot be null");
            // to ensure "args" is required (not null)
            this.Args = args ?? throw new ArgumentNullException("args is a required property for FunctionDef and cannot be null");
