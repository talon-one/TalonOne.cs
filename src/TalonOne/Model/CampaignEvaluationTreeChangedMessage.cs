...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEvaluationTreeChangedMessage :  IEquatable<CampaignEvaluationTreeChangedMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEvaluationTreeChangedMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignEvaluationTreeChangedMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEvaluationTreeChangedMessage" /> class.
        /// </summary>
        ...
        public CampaignEvaluationTreeChangedMessage(string notificationType = default(string), long totalResultSize = default(long), List<ApplicationNotification> data = default(List<ApplicationNotification>))
        {
            // to ensure "notificationType" is required (not null)
            this.NotificationType = notificationType ?? throw new ArgumentNullException("notificationType is a required property for CampaignEvaluationTreeChangedMessage and cannot be null");
        ...
        {
            return this.Equals(input as CampaignEvaluationTreeChangedMessage);
        }

        /// <summary>
        /// Returns true if CampaignEvaluationTreeChangedMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEvaluationTreeChangedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEvaluationTreeChangedMessage input)
        {
            if (input == null)
                return false;
