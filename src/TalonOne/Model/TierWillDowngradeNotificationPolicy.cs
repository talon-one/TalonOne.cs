...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TierWillDowngradeNotificationPolicy :  IEquatable<TierWillDowngradeNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TierWillDowngradeNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TierWillDowngradeNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TierWillDowngradeNotificationPolicy" /> class.
        /// </summary>
        ...
        public TierWillDowngradeNotificationPolicy(string name = default(string), bool batchingEnabled = true, long batchSize = 1000, List<TierWillDowngradeNotificationTrigger> triggers = default(List<TierWillDowngradeNotificationTrigger>))
        {
        ...
        {
            return this.Equals(input as TierWillDowngradeNotificationPolicy);
        }

        /// <summary>
        /// Returns true if TierWillDowngradeNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of TierWillDowngradeNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TierWillDowngradeNotificationPolicy input)
        {
            if (input == null)
                return false;
