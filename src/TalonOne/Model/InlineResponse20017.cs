...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(bool hasMore = default(bool), List<LoyaltyProgramTransaction> data = default(List<LoyaltyProgramTransaction>))
        {
            this.HasMore = hasMore;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20017 and cannot be null");
        }
