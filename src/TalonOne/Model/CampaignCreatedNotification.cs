...
namespace TalonOne.Model
{
    ...
    public partial class CampaignCreatedNotification :  IEquatable<CampaignCreatedNotification>, IValidatableObject
    {
        ...
        public CampaignCreatedNotification(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<CampaignCreatedNotificationItem> data = default(List<CampaignCreatedNotificationItem>))
        {
