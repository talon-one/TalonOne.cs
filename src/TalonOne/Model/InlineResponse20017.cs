...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(bool hasMore = default(bool), List<ApplicationEvent> data = default(List<ApplicationEvent>))
        {
            // to ensure "hasMore" is required (not null)
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for InlineResponse20017 and cannot be null");
            }
            else
            {
