...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardAddedDeductedPointsBalancesNotification :  IEquatable<CardAddedDeductedPointsBalancesNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public enum NotificationTypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "LoyaltyCardAddedDeductedPointsBalances")]
        ...
        protected CardAddedDeductedPointsBalancesNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CardAddedDeductedPointsBalancesNotification" /> class.
        /// </summary>
        ...
        public CardAddedDeductedPointsBalancesNotification(string cardIdentifier = default(string), string employeeName = default(string), long loyaltyProgramID = default(long), NotificationTypeEnum notificationType = default(NotificationTypeEnum), List<string> profileIntegrationIDs = default(List<string>), string sessionIntegrationID = default(string), string subledgerID = default(string), TypeOfChangeEnum typeOfChange = default(TypeOfChangeEnum), long userID = default(long), long usersPerCardLimit = default(long), List<AddedDeductedPointsBalancesAction> actions = default(List<AddedDeductedPointsBalancesAction>), decimal currentPoints = default(decimal))
        {
            // to ensure "cardIdentifier" is required (not null)
            this.CardIdentifier = cardIdentifier ?? throw new ArgumentNullException("cardIdentifier is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
            // to ensure "employeeName" is required (not null)
            this.EmployeeName = employeeName ?? throw new ArgumentNullException("employeeName is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
            this.LoyaltyProgramID = loyaltyProgramID;
            this.NotificationType = notificationType;
            // to ensure "profileIntegrationIDs" is required (not null)
            this.ProfileIntegrationIDs = profileIntegrationIDs ?? throw new ArgumentNullException("profileIntegrationIDs is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
            // to ensure "sessionIntegrationID" is required (not null)
            this.SessionIntegrationID = sessionIntegrationID ?? throw new ArgumentNullException("sessionIntegrationID is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
            // to ensure "subledgerID" is required (not null)
            this.SubledgerID = subledgerID ?? throw new ArgumentNullException("subledgerID is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
            this.TypeOfChange = typeOfChange;
            this.UserID = userID;
            this.UsersPerCardLimit = usersPerCardLimit;
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for CardAddedDeductedPointsBalancesNotification and cannot be null");
        ...
        {
            return this.Equals(input as CardAddedDeductedPointsBalancesNotification);
        }

        /// <summary>
        /// Returns true if CardAddedDeductedPointsBalancesNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of CardAddedDeductedPointsBalancesNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardAddedDeductedPointsBalancesNotification input)
        {
            if (input == null)
                return false;
