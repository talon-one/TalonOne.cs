...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutgoingIntegrationConfiguration :  IEquatable<OutgoingIntegrationConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutgoingIntegrationConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OutgoingIntegrationConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OutgoingIntegrationConfiguration" /> class.
        /// </summary>
        ...
        public OutgoingIntegrationConfiguration(int id = default(int), int accountId = default(int), int typeId = default(int), Object policy = default(Object))
        {
            ...
            this.Policy = policy ?? throw new ArgumentNullException("policy is a required property for OutgoingIntegrationConfiguration and cannot be null");
        }
        ...
        {
            return this.Equals(input as OutgoingIntegrationConfiguration);
        }

        /// <summary>
        /// Returns true if OutgoingIntegrationConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of OutgoingIntegrationConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutgoingIntegrationConfiguration input)
        {
            if (input == null)
                return false;
