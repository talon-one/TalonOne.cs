...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewGiveawaysPool :  IEquatable<NewGiveawaysPool>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewGiveawaysPool" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewGiveawaysPool() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewGiveawaysPool" /> class.
        /// </summary>
        ...
        public NewGiveawaysPool(string name = default(string), string description = default(string), List<int> subscribedApplicationsIds = default(List<int>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NewGiveawaysPool and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as NewGiveawaysPool);
        }

        /// <summary>
        /// Returns true if NewGiveawaysPool instances are equal
        /// </summary>
        /// <param name="input">Instance of NewGiveawaysPool to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewGiveawaysPool input)
        {
            if (input == null)
                return false;
