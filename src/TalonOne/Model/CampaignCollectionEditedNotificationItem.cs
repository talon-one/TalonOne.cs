...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignCollectionEditedNotificationItem :  IEquatable<CampaignCollectionEditedNotificationItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCollectionEditedNotificationItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignCollectionEditedNotificationItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCollectionEditedNotificationItem" /> class.
        /// </summary>
        ...
        public CampaignCollectionEditedNotificationItem(string _event = default(string), Campaign campaign = default(Campaign), Ruleset ruleset = default(Ruleset), CollectionWithoutPayload collection = default(CollectionWithoutPayload))
        {
            ...
            this.Campaign = campaign ?? throw new ArgumentNullException("campaign is a required property for CampaignCollectionEditedNotificationItem and cannot be null");
        ...
        {
            return this.Equals(input as CampaignCollectionEditedNotificationItem);
        }

        /// <summary>
        /// Returns true if CampaignCollectionEditedNotificationItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignCollectionEditedNotificationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignCollectionEditedNotificationItem input)
        {
            if (input == null)
                return false;
