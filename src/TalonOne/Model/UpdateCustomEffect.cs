...
namespace TalonOne.Model
{
    ...
    public partial class UpdateCustomEffect :  IEquatable<UpdateCustomEffect>, IValidatableObject
    {
        ...
        public UpdateCustomEffect(List<int> applicationIds = default(List<int>), bool isPerItem = default(bool), string name = default(string), string title = default(string), string payload = default(string), string description = default(string), bool enabled = default(bool), List<TemplateArgDef> _params = default(List<TemplateArgDef>))
        {
        ...
        [DataMember(Name="isPerItem", EmitDefaultValue=false)]
        ...
        public bool Equals(UpdateCustomEffect input)
        {
            ...
            return 
                ...
                (
                    this.IsPerItem == input.IsPerItem ||
                    this.IsPerItem.Equals(input.IsPerItem)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.IsPerItem.GetHashCode();
                if (this.Name != null)
