...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchievementBase :  IEquatable<AchievementBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AchievementBase);
        }

        /// <summary>
        /// Returns true if AchievementBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AchievementBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchievementBase input)
        {
            if (input == null)
                return false;
