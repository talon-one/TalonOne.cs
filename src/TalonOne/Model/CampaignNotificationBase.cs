...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignNotificationBase :  IEquatable<CampaignNotificationBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignNotificationBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignNotificationBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignNotificationBase" /> class.
        /// </summary>
        ...
        public CampaignNotificationBase(string notificationType = default(string), long totalResultSize = default(long))
        {
            // to ensure "notificationType" is required (not null)
            this.NotificationType = notificationType ?? throw new ArgumentNullException("notificationType is a required property for CampaignNotificationBase and cannot be null");
        ...
        {
            return this.Equals(input as CampaignNotificationBase);
        }

        /// <summary>
        /// Returns true if CampaignNotificationBase instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignNotificationBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignNotificationBase input)
        {
            if (input == null)
                return false;
