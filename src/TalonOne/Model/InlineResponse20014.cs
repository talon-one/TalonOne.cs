...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(int? totalResultSize = default(int?), List<CustomerActivityReport> data = default(List<CustomerActivityReport>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20014 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20014 and cannot be null");
            }
            else
            {
                this.Data = data;
