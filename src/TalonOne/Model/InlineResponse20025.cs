...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(bool hasMore = default(bool), long totalResultSize = default(long), List<ApplicationCustomer> data = default(List<ApplicationCustomer>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20025 and cannot be null");
