...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateCampaignTags :  IEquatable<GenerateCampaignTags>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCampaignTags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateCampaignTags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateCampaignTags" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GenerateCampaignTags);
        }

        /// <summary>
        /// Returns true if GenerateCampaignTags instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateCampaignTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateCampaignTags input)
        {
            if (input == null)
                return false;
