...
namespace TalonOne.Model
{
    ...
    public partial class Rule :  IEquatable<Rule>, IValidatableObject
    {
        ...
        public Rule(Guid id = default(Guid), Guid parentId = default(Guid), string title = default(string), string description = default(string), List<Binding> bindings = default(List<Binding>), List<Object> condition = default(List<Object>), List<Object> effects = default(List<Object>))
        {
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for Rule and cannot be null");
            // to ensure "condition" is required (not null)
            this.Condition = condition ?? throw new ArgumentNullException("condition is a required property for Rule and cannot be null");
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for Rule and cannot be null");
            this.Id = id;
