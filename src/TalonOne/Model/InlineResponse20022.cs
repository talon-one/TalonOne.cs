...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>, IValidatableObject
    {
        ...
        public InlineResponse20022(int? totalResultSize = default(int?), List<WebhookActivationLogEntry> data = default(List<WebhookActivationLogEntry>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
                this.Data = data;
