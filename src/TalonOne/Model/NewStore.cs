...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewStore :  IEquatable<NewStore>, IValidatableObject
    {
        /// <summary>
        ...
        public NewStore(string name = default(string), string description = default(string), Object attributes = default(Object), string integrationId = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for NewStore and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for NewStore and cannot be null");
            // to ensure "integrationId" is required (not null)
            this.IntegrationId = integrationId ?? throw new ArgumentNullException("integrationId is a required property for NewStore and cannot be null");
        ...
        {
            return this.Equals(input as NewStore);
        }

        /// <summary>
        /// Returns true if NewStore instances are equal
        /// </summary>
        /// <param name="input">Instance of NewStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewStore input)
        {
            if (input == null)
                return false;
