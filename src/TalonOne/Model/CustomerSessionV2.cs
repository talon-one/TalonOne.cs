...
namespace TalonOne.Model
{
    ...
    public partial class CustomerSessionV2 :  IEquatable<CustomerSessionV2>, IValidatableObject
    {
        ...
        /// <param name="profileId">ID of the customers profile as used within this Talon.One account.  **Note:** If the customer does not yet have a known profileId, we recommend you use a guest profileId.  (required).</param>
        ...
        /// <param name="attributes">A key-value map of the sessions attributes. If you use custom attributes, they must be created in the Campaign Manager before you set them with this property. For more information, see [Attributes](https://docs.talon.one/docs/dev/concepts/attributes).  (required).</param>
