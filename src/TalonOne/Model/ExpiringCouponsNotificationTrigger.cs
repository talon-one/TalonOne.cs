...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpiringCouponsNotificationTrigger :  IEquatable<ExpiringCouponsNotificationTrigger>, IValidatableObject
    {
        /// <summary>
        ...
        protected ExpiringCouponsNotificationTrigger() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpiringCouponsNotificationTrigger" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExpiringCouponsNotificationTrigger);
        }

        /// <summary>
        /// Returns true if ExpiringCouponsNotificationTrigger instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpiringCouponsNotificationTrigger to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpiringCouponsNotificationTrigger input)
        {
            if (input == null)
                return false;
