...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(bool? hasMore = default(bool?), List<Coupon> data = default(List<Coupon>))
        {
            // to ensure "hasMore" is required (not null)
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
