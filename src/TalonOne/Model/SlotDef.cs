...
namespace TalonOne.Model
{
    ...
    public partial class SlotDef :  IEquatable<SlotDef>, IValidatableObject
    {
        ...
        public SlotDef(string name = default(string), string type = default(string), string title = default(string), string description = default(string), string help = default(string), bool writable = default(bool))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SlotDef and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for SlotDef and cannot be null");
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for SlotDef and cannot be null");
