...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20020 :  IEquatable<InlineResponse20020>, IValidatableObject
    {
        ...
        public InlineResponse20020(int? totalResultSize = default(int?), List<Webhook> data = default(List<Webhook>))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20020 and cannot be null");
            }
            else
            {
                this.Data = data;
