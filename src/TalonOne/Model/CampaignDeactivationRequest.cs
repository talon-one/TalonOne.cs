...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignDeactivationRequest :  IEquatable<CampaignDeactivationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignDeactivationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignDeactivationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignDeactivationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CampaignDeactivationRequest);
        }

        /// <summary>
        /// Returns true if CampaignDeactivationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignDeactivationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignDeactivationRequest input)
        {
            if (input == null)
                return false;
