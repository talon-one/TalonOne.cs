...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20036 :  IEquatable<InlineResponse20036>, IValidatableObject
    {
        ...
        public InlineResponse20036(int totalResultSize = default(int), List<WebhookWithOutgoingIntegrationDetails> data = default(List<WebhookWithOutgoingIntegrationDetails>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20036 and cannot be null");
        }
