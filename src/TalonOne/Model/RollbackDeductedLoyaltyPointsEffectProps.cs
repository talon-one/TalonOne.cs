...
namespace TalonOne.Model
{
    ...
    public partial class RollbackDeductedLoyaltyPointsEffectProps :  IEquatable<RollbackDeductedLoyaltyPointsEffectProps>, IValidatableObject
    {
        ...
        public RollbackDeductedLoyaltyPointsEffectProps(int programId = default(int), string subLedgerId = default(string), decimal value = default(decimal), string recipientIntegrationId = default(string), DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), string transactionUUID = default(string))
        {
            ...
            this.SubLedgerId = subLedgerId ?? throw new ArgumentNullException("subLedgerId is a required property for RollbackDeductedLoyaltyPointsEffectProps and cannot be null");
            this.Value = value;
            // to ensure "recipientIntegrationId" is required (not null)
            this.RecipientIntegrationId = recipientIntegrationId ?? throw new ArgumentNullException("recipientIntegrationId is a required property for RollbackDeductedLoyaltyPointsEffectProps and cannot be null");
            // to ensure "transactionUUID" is required (not null)
            this.TransactionUUID = transactionUUID ?? throw new ArgumentNullException("transactionUUID is a required property for RollbackDeductedLoyaltyPointsEffectProps and cannot be null");
