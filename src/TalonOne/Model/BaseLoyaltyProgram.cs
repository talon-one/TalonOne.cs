...
namespace TalonOne.Model
{
    ...
    public partial class BaseLoyaltyProgram :  IEquatable<BaseLoyaltyProgram>, IValidatableObject
    {
        ...
        public BaseLoyaltyProgram(string title = default(string), string description = default(string), List<long> subscribedApplications = default(List<long>), string defaultValidity = default(string), string defaultPending = default(string), bool allowSubledger = default(bool), long usersPerCardLimit = default(long), bool sandbox = default(bool), ProgramJoinPolicyEnum? programJoinPolicy = default(ProgramJoinPolicyEnum?), TiersExpirationPolicyEnum? tiersExpirationPolicy = default(TiersExpirationPolicyEnum?), DateTime tierCycleStartDate = default(DateTime), string tiersExpireIn = default(string), TiersDowngradePolicyEnum? tiersDowngradePolicy = default(TiersDowngradePolicyEnum?), CodeGeneratorSettings cardCodeSettings = default(CodeGeneratorSettings), ReturnPolicyEnum? returnPolicy = default(ReturnPolicyEnum?))
        {
            this.Title = title;
