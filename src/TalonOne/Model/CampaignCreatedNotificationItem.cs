...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignCreatedNotificationItem :  IEquatable<CampaignCreatedNotificationItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCreatedNotificationItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignCreatedNotificationItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCreatedNotificationItem" /> class.
        /// </summary>
        ...
        public CampaignCreatedNotificationItem(string _event = default(string), Campaign campaign = default(Campaign), Ruleset ruleset = default(Ruleset), List<PlaceholderDetails> placeholders = default(List<PlaceholderDetails>), CampaignEvaluationPosition evaluationPosition = default(CampaignEvaluationPosition))
        {
            // to ensure "_event" is required (not null)
            this.Event = _event ?? throw new ArgumentNullException("_event is a required property for CampaignCreatedNotificationItem and cannot be null");
            // to ensure "campaign" is required (not null)
            this.Campaign = campaign ?? throw new ArgumentNullException("campaign is a required property for CampaignCreatedNotificationItem and cannot be null");
            // to ensure "evaluationPosition" is required (not null)
            this.EvaluationPosition = evaluationPosition ?? throw new ArgumentNullException("evaluationPosition is a required property for CampaignCreatedNotificationItem and cannot be null");
        ...
        {
            return this.Equals(input as CampaignCreatedNotificationItem);
        }

        /// <summary>
        /// Returns true if CampaignCreatedNotificationItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignCreatedNotificationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignCreatedNotificationItem input)
        {
            if (input == null)
                return false;
