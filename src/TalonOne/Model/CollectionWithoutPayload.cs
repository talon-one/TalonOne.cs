...
namespace TalonOne.Model
{
    ...
    public partial class CollectionWithoutPayload :  IEquatable<CollectionWithoutPayload>, IValidatableObject
    {
        ...
        public CollectionWithoutPayload(long id = default(long), DateTime created = default(DateTime), long accountId = default(long), DateTime modified = default(DateTime), string description = default(string), List<long> subscribedApplicationsIds = default(List<long>), string name = default(string), long modifiedBy = default(long), long createdBy = default(long), long applicationId = default(long), long campaignId = default(long))
        {
            this.Id = id;
