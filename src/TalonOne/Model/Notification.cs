...
namespace TalonOne.Model
{
    ...
    public partial class Notification :  IEquatable<Notification>, IValidatableObject
    {
        ...
        public Notification(long id = default(long), string name = default(string), string description = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Notification and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for Notification and cannot be null");
        }
