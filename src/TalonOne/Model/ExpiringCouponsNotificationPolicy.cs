...
namespace TalonOne.Model
{
    ...
    public partial class ExpiringCouponsNotificationPolicy :  IEquatable<ExpiringCouponsNotificationPolicy>, IValidatableObject
    {
        ...
        public ExpiringCouponsNotificationPolicy(string name = default(string), List<ExpiringCouponsNotificationTrigger> triggers = default(List<ExpiringCouponsNotificationTrigger>), bool batchingEnabled = true, long batchSize = 1000)
        {
