...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StrikethroughSetDiscountPerItemEffectProps :  IEquatable<StrikethroughSetDiscountPerItemEffectProps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StrikethroughSetDiscountPerItemEffectProps" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StrikethroughSetDiscountPerItemEffectProps() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StrikethroughSetDiscountPerItemEffectProps" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as StrikethroughSetDiscountPerItemEffectProps);
        }

        /// <summary>
        /// Returns true if StrikethroughSetDiscountPerItemEffectProps instances are equal
        /// </summary>
        /// <param name="input">Instance of StrikethroughSetDiscountPerItemEffectProps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StrikethroughSetDiscountPerItemEffectProps input)
        {
            if (input == null)
                return false;
