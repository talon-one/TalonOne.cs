...
namespace TalonOne.Model
{
    ...
    public partial class NewWebhook :  IEquatable<NewWebhook>, IValidatableObject
    {
        ...
        public NewWebhook(List<long> applicationIds = default(List<long>), string title = default(string), string description = default(string), bool draft = default(bool), VerbEnum verb = default(VerbEnum), string url = default(string), List<string> headers = default(List<string>), string payload = default(string), List<TemplateArgDef> _params = default(List<TemplateArgDef>), bool enabled = default(bool), long authenticationId = default(long))
        {
