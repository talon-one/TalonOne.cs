...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignStateChangedNotificationItem :  IEquatable<CampaignStateChangedNotificationItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStateChangedNotificationItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignStateChangedNotificationItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStateChangedNotificationItem" /> class.
        /// </summary>
        ...
        public CampaignStateChangedNotificationItem(string _event = default(string), Campaign campaign = default(Campaign), string oldState = default(string), string newState = default(string), Ruleset ruleset = default(Ruleset), List<PlaceholderDetails> placeholders = default(List<PlaceholderDetails>))
        {
            // to ensure "_event" is required (not null)
            this.Event = _event ?? throw new ArgumentNullException("_event is a required property for CampaignStateChangedNotificationItem and cannot be null");
            // to ensure "campaign" is required (not null)
            this.Campaign = campaign ?? throw new ArgumentNullException("campaign is a required property for CampaignStateChangedNotificationItem and cannot be null");
            // to ensure "oldState" is required (not null)
            this.OldState = oldState ?? throw new ArgumentNullException("oldState is a required property for CampaignStateChangedNotificationItem and cannot be null");
            // to ensure "newState" is required (not null)
            this.NewState = newState ?? throw new ArgumentNullException("newState is a required property for CampaignStateChangedNotificationItem and cannot be null");
        ...
        {
            return this.Equals(input as CampaignStateChangedNotificationItem);
        }

        /// <summary>
        /// Returns true if CampaignStateChangedNotificationItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignStateChangedNotificationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignStateChangedNotificationItem input)
        {
            if (input == null)
                return false;
