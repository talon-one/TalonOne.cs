...
namespace TalonOne.Model
{
    ...
    public partial class CreateCouponData :  IEquatable<CreateCouponData>, IValidatableObject
    {
        ...
        public CreateCouponData(List<ExtendedCoupon> data = default(List<ExtendedCoupon>), long totalResultSize = default(long), string batchID = default(string), string typeOfChange = default(string), string operation = default(string), string employeeName = default(string), NotificationTypeEnum notificationType = default(NotificationTypeEnum))
        {
