...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20042 :  IEquatable<InlineResponse20042>, IValidatableObject
    {
        ...
        protected InlineResponse20042() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20042" /> class.
        /// </summary>
        /// <param name="totalResultSize">totalResultSize (required).</param>
        /// <param name="data">data (required).</param>
        public InlineResponse20042(int totalResultSize = default(int), List<Export> data = default(List<Export>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20042 and cannot be null");
        }
