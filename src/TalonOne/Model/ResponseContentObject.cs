...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseContentObject :  IEquatable<ResponseContentObject>, IValidatableObject
    {
        /// <summary>
        ...
        public ResponseContentObject(List<ResponseContentEnum> responseContent = default(List<ResponseContentEnum>))
        {
        ...
        {
            return this.Equals(input as ResponseContentObject);
        }

        /// <summary>
        /// Returns true if ResponseContentObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseContentObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseContentObject input)
        {
            if (input == null)
                return false;
