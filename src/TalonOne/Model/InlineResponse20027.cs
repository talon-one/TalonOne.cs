...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20027 :  IEquatable<InlineResponse20027>, IValidatableObject
    {
        ...
        public InlineResponse20027(int? totalResultSize = default(int?), List<Export> data = default(List<Export>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20027 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20027 and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public List<Export> Data { get; set; }
