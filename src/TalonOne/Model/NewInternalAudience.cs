...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewInternalAudience :  IEquatable<NewInternalAudience>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewInternalAudience" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewInternalAudience() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewInternalAudience" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NewInternalAudience);
        }

        /// <summary>
        /// Returns true if NewInternalAudience instances are equal
        /// </summary>
        /// <param name="input">Instance of NewInternalAudience to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewInternalAudience input)
        {
            if (input == null)
                return false;
