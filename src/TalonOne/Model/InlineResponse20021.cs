...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20021 :  IEquatable<InlineResponse20021>, IValidatableObject
    {
        ...
        public InlineResponse20021(int? totalResultSize = default(int?), List<WebhookActivationLogEntry> data = default(List<WebhookActivationLogEntry>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20021 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20021 and cannot be null");
            }
            else
            {
                this.Data = data;
