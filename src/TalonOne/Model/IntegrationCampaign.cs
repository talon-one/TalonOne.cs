...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationCampaign :  IEquatable<IntegrationCampaign>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as IntegrationCampaign);
        }

        /// <summary>
        /// Returns true if IntegrationCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationCampaign input)
        {
            if (input == null)
                return false;
