...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>, IValidatableObject
    {
        ...
        public InlineResponse20016(int? totalResultSize = default(int?), List<ApplicationSession> data = default(List<ApplicationSession>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20016 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20016 and cannot be null");
            }
            else
            {
                this.Data = data;
