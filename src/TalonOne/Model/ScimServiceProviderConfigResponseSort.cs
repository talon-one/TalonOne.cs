...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScimServiceProviderConfigResponseSort :  IEquatable<ScimServiceProviderConfigResponseSort>, IValidatableObject
    {
        /// <summary>
        ...
        public ScimServiceProviderConfigResponseSort(bool supported = default(bool))
        {
        ...
        {
            return this.Equals(input as ScimServiceProviderConfigResponseSort);
        }

        /// <summary>
        /// Returns true if ScimServiceProviderConfigResponseSort instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimServiceProviderConfigResponseSort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimServiceProviderConfigResponseSort input)
        {
            if (input == null)
                return false;
