...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse201 :  IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        public InlineResponse201(long totalResultSize = default(long), List<Referral> data = default(List<Referral>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse201 and cannot be null");
        }
