...
namespace TalonOne.Model
{
    ...
    public partial class CollectionItem :  IEquatable<CollectionItem>, IValidatableObject
    {
        ...
        public CollectionItem(string item = default(string))
        {
            // to ensure "item" is required (not null)
            this.Item = item ?? throw new ArgumentNullException("item is a required property for CollectionItem and cannot be null");
        }
