...
namespace TalonOne.Model
{
    ...
    public partial class NewInvitation :  IEquatable<NewInvitation>, IValidatableObject
    {
        ...
        public NewInvitation(string name = default(string), string email = default(string), string acl = default(string), List<int?> roles = default(List<int?>))
        {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for NewInvitation and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            if (acl == null)
            {
                throw new InvalidDataException("acl is a required property for NewInvitation and cannot be null");
            }
            else
            {
                this.Acl = acl;
