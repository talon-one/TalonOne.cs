...
namespace TalonOne.Model
{
    ...
    public partial class AccountAdditionalCost :  IEquatable<AccountAdditionalCost>, IValidatableObject
    {
        ...
        public AccountAdditionalCost(int id = default(int), DateTime created = default(DateTime), int accountId = default(int), string name = default(string), string title = default(string), string description = default(string), List<int> subscribedApplicationsIds = default(List<int>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for AccountAdditionalCost and cannot be null");
            }
            else
            {
