...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationResponse :  IEquatable<IntegrationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IntegrationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationResponse" /> class.
        /// </summary>
        ...
        public IntegrationResponse(CustomerProfile customerProfile = default(CustomerProfile), Loyalty loyalty = default(Loyalty), List<Campaign> triggeredCampaigns = default(List<Campaign>), List<Effect> effects = default(List<Effect>), List<RuleFailureReason> ruleFailureReasons = default(List<RuleFailureReason>), List<Coupon> createdCoupons = default(List<Coupon>), List<Referral> createdReferrals = default(List<Referral>), List<Giveaway> awardedGiveaways = default(List<Giveaway>))
        {
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for IntegrationResponse and cannot be null");
            // to ensure "createdCoupons" is required (not null)
            this.CreatedCoupons = createdCoupons ?? throw new ArgumentNullException("createdCoupons is a required property for IntegrationResponse and cannot be null");
            // to ensure "createdReferrals" is required (not null)
            this.CreatedReferrals = createdReferrals ?? throw new ArgumentNullException("createdReferrals is a required property for IntegrationResponse and cannot be null");
        ...
        {
            return this.Equals(input as IntegrationResponse);
        }

        /// <summary>
        /// Returns true if IntegrationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationResponse input)
        {
            if (input == null)
                return false;
