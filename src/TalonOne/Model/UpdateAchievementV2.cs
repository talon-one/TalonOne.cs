...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateAchievementV2 :  IEquatable<UpdateAchievementV2>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateAchievementV2);
        }

        /// <summary>
        /// Returns true if UpdateAchievementV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAchievementV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAchievementV2 input)
        {
            if (input == null)
                return false;
