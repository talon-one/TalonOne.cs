...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewApplicationCIF :  IEquatable<NewApplicationCIF>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewApplicationCIF" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewApplicationCIF() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewApplicationCIF" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NewApplicationCIF);
        }

        /// <summary>
        /// Returns true if NewApplicationCIF instances are equal
        /// </summary>
        /// <param name="input">Instance of NewApplicationCIF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewApplicationCIF input)
        {
            if (input == null)
                return false;
