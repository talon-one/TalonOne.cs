...
namespace TalonOne.Model
{
    ...
    public partial class NewCouponCreationJob :  IEquatable<NewCouponCreationJob>, IValidatableObject
    {
        ...
        public NewCouponCreationJob(int usageLimit = default(int), decimal discountLimit = default(decimal), DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), int numberOfCoupons = default(int), CodeGeneratorSettings couponSettings = default(CodeGeneratorSettings), Object attributes = default(Object))
        {
