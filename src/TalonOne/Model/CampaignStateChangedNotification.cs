...
namespace TalonOne.Model
{
    ...
    public partial class CampaignStateChangedNotification :  IEquatable<CampaignStateChangedNotification>, IValidatableObject
    {
        ...
        public CampaignStateChangedNotification(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<CampaignStateChangedNotificationItem> data = default(List<CampaignStateChangedNotificationItem>))
        {
