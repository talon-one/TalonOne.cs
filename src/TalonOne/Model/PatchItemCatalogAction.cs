...
namespace TalonOne.Model
{
    ...
    public partial class PatchItemCatalogAction :  IEquatable<PatchItemCatalogAction>, IValidatableObject
    {
        ...
        protected PatchItemCatalogAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchItemCatalogAction" /> class.
        /// </summary>
        ...
        [DataMember(Name="createIfNotExists", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as PatchItemCatalogAction);
        }

        /// <summary>
        /// Returns true if PatchItemCatalogAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchItemCatalogAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchItemCatalogAction input)
        {
            if (input == null)
                return false;
