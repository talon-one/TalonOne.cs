...
namespace TalonOne.Model
{
    ...
    public partial class Effect :  IEquatable<Effect>, IValidatableObject
    {
        ...
        public Effect(int campaignId = default(int), int rulesetId = default(int), int ruleIndex = default(int), string ruleName = default(string), string effectType = default(string), int triggeredByCoupon = default(int), Object props = default(Object))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new InvalidDataException("campaignId is a required property for Effect and cannot be null");
            }
            else
            {
            ...
            if (rulesetId == null)
            {
                throw new InvalidDataException("rulesetId is a required property for Effect and cannot be null");
            }
            else
            {
            ...
            if (ruleIndex == null)
            {
                throw new InvalidDataException("ruleIndex is a required property for Effect and cannot be null");
            }
            else
            {
            ...
            if (ruleName == null)
            {
                throw new InvalidDataException("ruleName is a required property for Effect and cannot be null");
            }
            else
            {
            ...
            if (effectType == null)
            {
                throw new InvalidDataException("effectType is a required property for Effect and cannot be null");
            }
            else
            {
            ...
            if (props == null)
            {
                throw new InvalidDataException("props is a required property for Effect and cannot be null");
            }
            else
            {
                this.Props = props;
