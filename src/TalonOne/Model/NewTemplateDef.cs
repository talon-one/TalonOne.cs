...
namespace TalonOne.Model
{
    ...
    public partial class NewTemplateDef :  IEquatable<NewTemplateDef>, IValidatableObject
    {
        ...
        public NewTemplateDef(string title = default(string), string description = default(string), string help = default(string), string category = default(string), List<Object> expr = default(List<Object>), List<TemplateArgDef> args = default(List<TemplateArgDef>), bool expose = false)
        {
            ...
            this.Title = title ?? throw new ArgumentNullException("title is a required property for NewTemplateDef and cannot be null");
            // to ensure "category" is required (not null)
            this.Category = category ?? throw new ArgumentNullException("category is a required property for NewTemplateDef and cannot be null");
            // to ensure "expr" is required (not null)
            this.Expr = expr ?? throw new ArgumentNullException("expr is a required property for NewTemplateDef and cannot be null");
            // to ensure "args" is required (not null)
            this.Args = args ?? throw new ArgumentNullException("args is a required property for NewTemplateDef and cannot be null");
