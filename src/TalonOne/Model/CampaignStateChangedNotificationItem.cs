...
namespace TalonOne.Model
{
    ...
    public partial class CampaignStateChangedNotificationItem :  IEquatable<CampaignStateChangedNotificationItem>, IValidatableObject
    {
        ...
        public CampaignStateChangedNotificationItem(string _event = default(string), Campaign campaign = default(Campaign), string oldState = default(string), string newState = default(string), Ruleset ruleset = default(Ruleset))
        {
