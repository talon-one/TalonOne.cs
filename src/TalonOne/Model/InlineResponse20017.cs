...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(int? totalResultSize = default(int?), List<ApplicationEvent> data = default(List<ApplicationEvent>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20017 and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse20017 and cannot be null");
            }
            else
            {
                this.Data = data;
