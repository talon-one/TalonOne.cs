...
namespace TalonOne.Model
{
    ...
    public partial class BaseSamlConnection :  IEquatable<BaseSamlConnection>, IValidatableObject
    {
        ...
        public BaseSamlConnection(int accountId = default(int), string name = default(string), bool enabled = default(bool), string issuer = default(string), string signOnURL = default(string), string signOutURL = default(string), string metadataURL = default(string), string audienceURI = default(string))
        {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for BaseSamlConnection and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for BaseSamlConnection and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for BaseSamlConnection and cannot be null");
            }
            else
            {
            ...
            if (issuer == null)
            {
                throw new InvalidDataException("issuer is a required property for BaseSamlConnection and cannot be null");
            }
            else
            {
                this.Issuer = issuer;
            ...
            if (signOnURL == null)
            {
                throw new InvalidDataException("signOnURL is a required property for BaseSamlConnection and cannot be null");
            }
            else
            {
