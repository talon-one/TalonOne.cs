...
namespace TalonOne.Model
{
    ...
    public partial class ApplicationEvent :  IEquatable<ApplicationEvent>, IValidatableObject
    {
        ...
        public ApplicationEvent(int id = default(int), DateTime created = default(DateTime), int applicationId = default(int), int profileId = default(int), int sessionId = default(int), string type = default(string), Object attributes = default(Object), List<Object> effects = default(List<Object>), List<RuleFailureReason> ruleFailureReasons = default(List<RuleFailureReason>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationId is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
            ...
            if (effects == null)
            {
                throw new InvalidDataException("effects is a required property for ApplicationEvent and cannot be null");
            }
            else
            {
