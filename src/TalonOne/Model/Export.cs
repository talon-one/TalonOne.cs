...
namespace TalonOne.Model
{
    ...
    public partial class Export :  IEquatable<Export>, IValidatableObject
    {
        ...
        public Export(int id = default(int), DateTime created = default(DateTime), int accountId = default(int), int userId = default(int), EntityEnum entity = default(EntityEnum), Object filter = default(Object))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Export and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for Export and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for Export and cannot be null");
            }
            else
            {
            ...
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for Export and cannot be null");
            }
            else
            {
                this.UserId = userId;
            ...
            if (entity == null)
            {
                throw new InvalidDataException("entity is a required property for Export and cannot be null");
            }
            else
            {
                this.Entity = entity;
            ...
            if (filter == null)
            {
                throw new InvalidDataException("filter is a required property for Export and cannot be null");
            }
            else
            {
                this.Filter = filter;
