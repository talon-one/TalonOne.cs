...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponEntity :  IEquatable<CouponEntity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CouponEntity);
        }

        /// <summary>
        /// Returns true if CouponEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponEntity input)
        {
            if (input == null)
                return false;
