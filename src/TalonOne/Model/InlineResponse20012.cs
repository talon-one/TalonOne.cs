...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(int? totalResultSize = default(int?), List<ApplicationCustomer> data = default(List<ApplicationCustomer>))
        {
            // to ensure "totalResultSize" is required (not null)
            if (totalResultSize == null)
            {
                throw new InvalidDataException("totalResultSize is a required property for InlineResponse20012 and cannot be null");
            }
            else
            {
