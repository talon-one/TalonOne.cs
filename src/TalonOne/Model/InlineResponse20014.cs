...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(bool hasMore = default(bool), List<CustomerActivityReport> data = default(List<CustomerActivityReport>))
        {
            // to ensure "hasMore" is required (not null)
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for InlineResponse20014 and cannot be null");
            }
            else
            {
