...
namespace TalonOne.Model
{
    ...
    public partial class CampaignRulesetChangedNotification :  IEquatable<CampaignRulesetChangedNotification>, IValidatableObject
    {
        ...
        public CampaignRulesetChangedNotification(NotificationTypeEnum notificationType = default(NotificationTypeEnum), long totalResultSize = default(long), List<CampaignRulesetChangedNotificationItem> data = default(List<CampaignRulesetChangedNotificationItem>))
        {
