...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CouponWithApplication :  IEquatable<CouponWithApplication>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponWithApplication" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CouponWithApplication() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponWithApplication" /> class.
        /// </summary>
        ...
        /// <param name="applicationName">Name of the Application that is connected to the coupon. (required).</param>
        public CouponWithApplication(long id = default(long), DateTime created = default(DateTime), long campaignId = default(long), string value = default(string), long usageLimit = default(long), decimal discountLimit = default(decimal), long reservationLimit = default(long), DateTime startDate = default(DateTime), DateTime expiryDate = default(DateTime), List<LimitConfig> limits = default(List<LimitConfig>), long usageCounter = default(long), decimal discountCounter = default(decimal), decimal discountRemainder = default(decimal), decimal reservationCounter = default(decimal), Object attributes = default(Object), long referralId = default(long), string recipientIntegrationId = default(string), long importId = default(long), bool reservation = true, string batchId = default(string), bool isReservationMandatory = false, bool implicitlyReserved = default(bool), long applicationId = default(long), string applicationName = default(string))
        {
            this.Id = id;
            this.Created = created;
            this.CampaignId = campaignId;
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for CouponWithApplication and cannot be null");
            this.UsageLimit = usageLimit;
            this.UsageCounter = usageCounter;
            this.ApplicationId = applicationId;
            // to ensure "applicationName" is required (not null)
            this.ApplicationName = applicationName ?? throw new ArgumentNullException("applicationName is a required property for CouponWithApplication and cannot be null");
        ...
        /// </summary>
        /// <value>Name of the Application that is connected to the coupon.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CouponWithApplication {\n");
        ...
        {
            return this.Equals(input as CouponWithApplication);
        }

        /// <summary>
        /// Returns true if CouponWithApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of CouponWithApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CouponWithApplication input)
        {
            if (input == null)
                return false;
