...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20048 :  IEquatable<InlineResponse20048>, IValidatableObject
    {
        ...
        protected InlineResponse20048() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20048" /> class.
        /// </summary>
        /// <param name="hasMore">hasMore.</param>
        /// <param name="data">data (required).</param>
        public InlineResponse20048(bool hasMore = default(bool), List<ApplicationCIF> data = default(List<ApplicationCIF>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20048 and cannot be null");
        ...
        public List<ApplicationCIF> Data { get; set; }
