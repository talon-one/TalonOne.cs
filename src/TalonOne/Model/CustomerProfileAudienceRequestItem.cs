...
namespace TalonOne.Model
{
    ...
    public partial class CustomerProfileAudienceRequestItem :  IEquatable<CustomerProfileAudienceRequestItem>, IValidatableObject
    {
        ...
        public CustomerProfileAudienceRequestItem(ActionEnum action = default(ActionEnum), string profileIntegrationId = default(string), int audienceId = default(int))
        {
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for CustomerProfileAudienceRequestItem and cannot be null");
            }
            else
            {
                this.Action = action;
            ...
            {
                throw new InvalidDataException("profileIntegrationId is a required property for CustomerProfileAudienceRequestItem and cannot be null");
            }
            else
            {
            ...
            if (audienceId == null)
            {
                throw new InvalidDataException("audienceId is a required property for CustomerProfileAudienceRequestItem and cannot be null");
            }
            else
            {
