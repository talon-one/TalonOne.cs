...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReopenSessionResponse :  IEquatable<ReopenSessionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReopenSessionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReopenSessionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReopenSessionResponse" /> class.
        /// </summary>
        ...
        public ReopenSessionResponse(List<Effect> effects = default(List<Effect>))
        {
            // to ensure "effects" is required (not null)
            this.Effects = effects ?? throw new ArgumentNullException("effects is a required property for ReopenSessionResponse and cannot be null");
        }
        ...
        {
            return this.Equals(input as ReopenSessionResponse);
        }

        /// <summary>
        /// Returns true if ReopenSessionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReopenSessionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReopenSessionResponse input)
        {
            if (input == null)
                return false;
