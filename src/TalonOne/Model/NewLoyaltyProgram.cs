...
namespace TalonOne.Model
{
    ...
    public partial class NewLoyaltyProgram :  IEquatable<NewLoyaltyProgram>, IValidatableObject
    {
        ...
        public NewLoyaltyProgram(string title = default(string), string description = default(string), List<long> subscribedApplications = default(List<long>), string defaultValidity = default(string), string defaultPending = default(string), bool allowSubledger = default(bool), long usersPerCardLimit = default(long), bool sandbox = default(bool), ProgramJoinPolicyEnum? programJoinPolicy = default(ProgramJoinPolicyEnum?), TiersExpirationPolicyEnum? tiersExpirationPolicy = default(TiersExpirationPolicyEnum?), DateTime tierCycleStartDate = default(DateTime), string tiersExpireIn = default(string), TiersDowngradePolicyEnum? tiersDowngradePolicy = default(TiersDowngradePolicyEnum?), CodeGeneratorSettings cardCodeSettings = default(CodeGeneratorSettings), ReturnPolicyEnum? returnPolicy = default(ReturnPolicyEnum?), string name = default(string), List<NewLoyaltyTier> tiers = default(List<NewLoyaltyTier>), string timezone = default(string), bool cardBased = false)
        {
        ...
        [DataMember(Name="tierCycleStartDate", EmitDefaultValue=false)]
        public DateTime TierCycleStartDate { get; set; }
        ...
        public bool Equals(NewLoyaltyProgram input)
        {
            ...
            return 
                ...
                (
                    this.TierCycleStartDate == input.TierCycleStartDate ||
                    (this.TierCycleStartDate != null &&
                    this.TierCycleStartDate.Equals(input.TierCycleStartDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TierCycleStartDate != null)
                    hashCode = hashCode * 59 + this.TierCycleStartDate.GetHashCode();
