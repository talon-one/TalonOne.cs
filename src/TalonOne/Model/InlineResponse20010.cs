...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(bool hasMore = default(bool), List<AccessLogEntry> data = default(List<AccessLogEntry>))
        {
            // to ensure "hasMore" is required (not null)
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
