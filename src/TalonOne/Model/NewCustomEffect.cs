...
namespace TalonOne.Model
{
    ...
    public partial class NewCustomEffect :  IEquatable<NewCustomEffect>, IValidatableObject
    {
        ...
        public NewCustomEffect(List<int> applicationIds = default(List<int>), string name = default(string), string title = default(string), string payload = default(string), string description = default(string), bool enabled = default(bool), List<TemplateArgDef> _params = default(List<TemplateArgDef>))
        {
