...
namespace TalonOne.Model
{
    ...
    public partial class LedgerPointsEntryIntegrationAPI :  IEquatable<LedgerPointsEntryIntegrationAPI>, IValidatableObject
    {
        ...
        public LedgerPointsEntryIntegrationAPI(long id = default(long), string transactionUUID = default(string), DateTime created = default(DateTime), long programId = default(long), string customerSessionId = default(string), string name = default(string), string startDate = default(string), string expiryDate = default(string), string subledgerId = default(string), decimal amount = default(decimal), string validityDuration = default(string))
        {
            this.Id = id;
