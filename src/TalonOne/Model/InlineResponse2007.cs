...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(bool hasMore = default(bool), List<LedgerPointsEntryIntegrationAPI> data = default(List<LedgerPointsEntryIntegrationAPI>))
        {
            this.HasMore = hasMore;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2007 and cannot be null");
        }
