...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewCustomEffect :  IEquatable<NewCustomEffect>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewCustomEffect" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewCustomEffect() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewCustomEffect" /> class.
        /// </summary>
        ...
        public NewCustomEffect(string name = default(string), string title = default(string), string payload = default(string), string description = default(string), bool enabled = default(bool), List<int> subscribedApplicationsIds = default(List<int>), List<TemplateArgDef> _params = default(List<TemplateArgDef>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NewCustomEffect and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewCustomEffect and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (payload == null)
            {
                throw new InvalidDataException("payload is a required property for NewCustomEffect and cannot be null");
            }
            else
            {
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for NewCustomEffect and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NewCustomEffect);
        }

        /// <summary>
        /// Returns true if NewCustomEffect instances are equal
        /// </summary>
        /// <param name="input">Instance of NewCustomEffect to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewCustomEffect input)
        {
            if (input == null)
                return false;
