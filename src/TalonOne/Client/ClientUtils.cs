...
namespace TalonOne.Client
{
    ...
    public static class ClientUtils
    {
        ...
        /// <summary>
        /// Converts contents from string to Memory Stream
        /// </summary>
        /// <param name="contents">the data that should be imported.</param>
        /// <returns>The contents in a Memory Stream.</returns>
        public static MemoryStream ParameterToStream(string contents)
        {
