...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAchievementV2 :  IEquatable<CreateAchievementV2>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAchievementV2(string name = default(string), string title = default(string), string description = default(string), decimal target = default(decimal), string period = default(string), RecurrencePolicyEnum? recurrencePolicy = default(RecurrencePolicyEnum?), ActivationPolicyEnum? activationPolicy = default(ActivationPolicyEnum?), DateTime fixedStartDate = default(DateTime), DateTime endDate = default(DateTime), bool allowRollbackAfterCompletion = default(bool), bool sandbox = default(bool), List<long> subscribedApplications = default(List<long>), string timezone = default(string))
        {
            ...
            this.Title = title ?? throw new ArgumentNullException("title is a required property for CreateAchievementV2 and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for CreateAchievementV2 and cannot be null");
            this.Target = target;
            this.Sandbox = sandbox;
            // to ensure "timezone" is required (not null)
            this.Timezone = timezone ?? throw new ArgumentNullException("timezone is a required property for CreateAchievementV2 and cannot be null");
            this.Period = period;
        ...
        {
            return this.Equals(input as CreateAchievementV2);
        }

        /// <summary>
        /// Returns true if CreateAchievementV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAchievementV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAchievementV2 input)
        {
            if (input == null)
                return false;
