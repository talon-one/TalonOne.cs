...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignGroupEntity :  IEquatable<CampaignGroupEntity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CampaignGroupEntity);
        }

        /// <summary>
        /// Returns true if CampaignGroupEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignGroupEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignGroupEntity input)
        {
            if (input == null)
                return false;
