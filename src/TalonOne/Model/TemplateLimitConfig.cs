...
namespace TalonOne.Model
{
    ...
    public partial class TemplateLimitConfig :  IEquatable<TemplateLimitConfig>, IValidatableObject
    {
        ...
        public TemplateLimitConfig(string action = default(string), decimal limit = default(decimal), List<EntitiesEnum> entities = default(List<EntitiesEnum>), string description = default(string))
        {
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for TemplateLimitConfig and cannot be null");
            }
            else
            {
                this.Action = action;
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for TemplateLimitConfig and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (entities == null)
            {
                throw new InvalidDataException("entities is a required property for TemplateLimitConfig and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for TemplateLimitConfig and cannot be null");
            }
            else
            {
