...
namespace TalonOne.Model
{
    ...
    public partial class ExpiringPointsNotificationPolicy :  IEquatable<ExpiringPointsNotificationPolicy>, IValidatableObject
    {
        ...
        public ExpiringPointsNotificationPolicy(string name = default(string), List<ExpiringPointsNotificationTrigger> triggers = default(List<ExpiringPointsNotificationTrigger>), bool batchingEnabled = true, int batchSize = default(int))
        {
