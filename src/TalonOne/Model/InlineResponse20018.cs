...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(long totalResultSize = default(long), List<LoyaltyDashboardData> data = default(List<LoyaltyDashboardData>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20018 and cannot be null");
        }
