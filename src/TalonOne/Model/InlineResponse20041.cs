...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20041 :  IEquatable<InlineResponse20041>, IValidatableObject
    {
        ...
        public InlineResponse20041(long totalResultSize = default(long), List<WebhookWithOutgoingIntegrationDetails> data = default(List<WebhookWithOutgoingIntegrationDetails>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20041 and cannot be null");
        }
