...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardExpiringPointsNotificationPolicy :  IEquatable<CardExpiringPointsNotificationPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardExpiringPointsNotificationPolicy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CardExpiringPointsNotificationPolicy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CardExpiringPointsNotificationPolicy" /> class.
        /// </summary>
        ...
        public List<CardExpiringPointsNotificationTrigger> Triggers { get; set; }
        ...
        {
            return this.Equals(input as CardExpiringPointsNotificationPolicy);
        }

        /// <summary>
        /// Returns true if CardExpiringPointsNotificationPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of CardExpiringPointsNotificationPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardExpiringPointsNotificationPolicy input)
        {
            if (input == null)
                return false;
