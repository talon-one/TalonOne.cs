...
namespace TalonOne.Model
{
    ...
    public partial class RejectReferralEffectProps :  IEquatable<RejectReferralEffectProps>, IValidatableObject
    {
        ...
        public RejectReferralEffectProps(string value = default(string), string rejectionReason = default(string), int conditionIndex = default(int), int effectIndex = default(int), string details = default(string))
        {
            ...
            this.RejectionReason = rejectionReason ?? throw new ArgumentNullException("rejectionReason is a required property for RejectReferralEffectProps and cannot be null");
