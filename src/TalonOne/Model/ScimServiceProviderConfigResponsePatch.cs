...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScimServiceProviderConfigResponsePatch :  IEquatable<ScimServiceProviderConfigResponsePatch>, IValidatableObject
    {
        /// <summary>
        ...
        public ScimServiceProviderConfigResponsePatch(bool supported = default(bool))
        {
        ...
        {
            return this.Equals(input as ScimServiceProviderConfigResponsePatch);
        }

        /// <summary>
        /// Returns true if ScimServiceProviderConfigResponsePatch instances are equal
        /// </summary>
        /// <param name="input">Instance of ScimServiceProviderConfigResponsePatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScimServiceProviderConfigResponsePatch input)
        {
            if (input == null)
                return false;
