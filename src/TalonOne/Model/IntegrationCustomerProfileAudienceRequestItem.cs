...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationCustomerProfileAudienceRequestItem :  IEquatable<IntegrationCustomerProfileAudienceRequestItem>, IValidatableObject
    {
        /// <summary>
        ...
        protected IntegrationCustomerProfileAudienceRequestItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationCustomerProfileAudienceRequestItem" /> class.
        /// </summary>
        ...
        public IntegrationCustomerProfileAudienceRequestItem(ActionEnum action = default(ActionEnum), string profileIntegrationId = default(string), string integrationId = default(string))
        {
            this.Action = action;
            // to ensure "profileIntegrationId" is required (not null)
            this.ProfileIntegrationId = profileIntegrationId ?? throw new ArgumentNullException("profileIntegrationId is a required property for IntegrationCustomerProfileAudienceRequestItem and cannot be null");
            // to ensure "integrationId" is required (not null)
            this.IntegrationId = integrationId ?? throw new ArgumentNullException("integrationId is a required property for IntegrationCustomerProfileAudienceRequestItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as IntegrationCustomerProfileAudienceRequestItem);
        }

        /// <summary>
        /// Returns true if IntegrationCustomerProfileAudienceRequestItem instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationCustomerProfileAudienceRequestItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationCustomerProfileAudienceRequestItem input)
        {
            if (input == null)
                return false;
