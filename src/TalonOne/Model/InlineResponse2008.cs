...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(bool hasMore = default(bool), int totalResultSize = default(int), List<Collection> data = default(List<Collection>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse2008 and cannot be null");
