...
namespace TalonOne.Model
{
    ...
    public partial class CustomerProfile :  IEquatable<CustomerProfile>, IValidatableObject
    {
        ...
        public CustomerProfile(string integrationId = default(string), DateTime created = default(DateTime), Object attributes = default(Object), int accountId = default(int), int closedSessions = default(int), decimal totalSales = default(decimal), List<LoyaltyMembership> loyaltyMemberships = default(List<LoyaltyMembership>), List<AudienceMembership> audienceMemberships = default(List<AudienceMembership>), DateTime lastActivity = default(DateTime))
        {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for CustomerProfile and cannot be null");
            }
            else
            {
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for CustomerProfile and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for CustomerProfile and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("closedSessions is a required property for CustomerProfile and cannot be null");
            }
            else
            {
            ...
            if (totalSales == null)
            {
                throw new InvalidDataException("totalSales is a required property for CustomerProfile and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lastActivity is a required property for CustomerProfile and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CustomerProfile);
        }

        /// <summary>
        /// Returns true if CustomerProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomerProfile input)
        {
            if (input == null)
                return false;
