...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewReturn :  IEquatable<NewReturn>, IValidatableObject
    {
        /// <summary>
        ...
        public NewReturn(List<ReturnedCartItem> returnedCartItems = default(List<ReturnedCartItem>))
        {
            // to ensure "returnedCartItems" is required (not null)
            this.ReturnedCartItems = returnedCartItems ?? throw new ArgumentNullException("returnedCartItems is a required property for NewReturn and cannot be null");
        }
        ...
        {
            return this.Equals(input as NewReturn);
        }

        /// <summary>
        /// Returns true if NewReturn instances are equal
        /// </summary>
        /// <param name="input">Instance of NewReturn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewReturn input)
        {
            if (input == null)
                return false;
