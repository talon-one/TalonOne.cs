...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20032 :  IEquatable<InlineResponse20032>, IValidatableObject
    {
        ...
        public InlineResponse20032(bool hasMore = default(bool), int totalResultSize = default(int), List<ApplicationReferee> data = default(List<ApplicationReferee>))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20032 and cannot be null");
