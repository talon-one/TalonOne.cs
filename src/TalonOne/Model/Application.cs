...
namespace TalonOne.Model
{
    ...
    public partial class Application :  IEquatable<Application>, IValidatableObject
    {
        ...
        public Application(int? id = default(int?), DateTime? created = default(DateTime?), DateTime? modified = default(DateTime?), int? accountId = default(int?), string name = default(string), string description = default(string), string key = default(string), string timezone = default(string), string currency = default(string), CaseSensitivityEnum? caseSensitivity = default(CaseSensitivityEnum?), Object attributes = default(Object), List<LimitConfig> limits = default(List<LimitConfig>), List<LoyaltyProgram> loyaltyPrograms = default(List<LoyaltyProgram>))
        {
