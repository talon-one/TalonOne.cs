...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignCollection :  IEquatable<CampaignCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCollection" /> class.
        /// </summary>
        ...
        public CampaignCollection(int id = default(int), DateTime created = default(DateTime), int accountId = default(int), DateTime modified = default(DateTime), string description = default(string), string name = default(string), int modifiedBy = default(int), int createdBy = default(int), int applicationId = default(int), int campaignId = default(int), List<string> payload = default(List<string>))
        {
            this.Id = id;
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CampaignCollection and cannot be null");
        ...
        {
            return this.Equals(input as CampaignCollection);
        }

        /// <summary>
        /// Returns true if CampaignCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignCollection input)
        {
            if (input == null)
                return false;
