...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(bool hasMore = default(bool), List<LoyaltyProgramTransaction> data = default(List<LoyaltyProgramTransaction>))
        {
            this.HasMore = hasMore;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20014 and cannot be null");
        }
