...
namespace TalonOne.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExperimentCampaignCopy :  IEquatable<ExperimentCampaignCopy>, IValidatableObject
    {
        /// <summary>
        ...
        public ExperimentCampaignCopy(string name = default(string), string description = default(string), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), List<string> tags = default(List<string>), long evaluationGroupId = default(long))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ExperimentCampaignCopy);
        }

        /// <summary>
        /// Returns true if ExperimentCampaignCopy instances are equal
        /// </summary>
        /// <param name="input">Instance of ExperimentCampaignCopy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExperimentCampaignCopy input)
        {
            if (input == null)
                return false;
