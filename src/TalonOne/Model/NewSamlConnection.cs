...
namespace TalonOne.Model
{
    ...
    public partial class NewSamlConnection :  IEquatable<NewSamlConnection>, IValidatableObject
    {
        ...
        public NewSamlConnection(string x509certificate = default(string), int? accountId = default(int?), string name = default(string), bool? enabled = default(bool?), string issuer = default(string), string signOnURL = default(string), string signOutURL = default(string), string metadataURL = default(string), string audienceURI = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NewSamlConnection and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for NewSamlConnection and cannot be null");
            }
            else
            {
            ...
            if (issuer == null)
            {
                throw new InvalidDataException("issuer is a required property for NewSamlConnection and cannot be null");
            }
            else
            {
                this.Issuer = issuer;
            ...
            if (signOnURL == null)
            {
                throw new InvalidDataException("signOnURL is a required property for NewSamlConnection and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NewSamlConnection);
        }

        /// <summary>
        /// Returns true if NewSamlConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of NewSamlConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewSamlConnection input)
        {
            if (input == null)
                return false;
