...
namespace TalonOne.Model
{
    ...
    public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        protected InlineResponse20035() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20035" /> class.
        /// </summary>
        /// <param name="totalResultSize">totalResultSize (required).</param>
        /// <param name="data">data (required).</param>
        public InlineResponse20035(int totalResultSize = default(int), List<WebhookActivationLogEntry> data = default(List<WebhookActivationLogEntry>))
        {
            this.TotalResultSize = totalResultSize;
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for InlineResponse20035 and cannot be null");
        }
